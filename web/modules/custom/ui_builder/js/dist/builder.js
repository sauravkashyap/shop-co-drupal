...
`+e)}c&&c(t,v),ce(`sending`),await new Promise(e=>W(e,150));let n=await Hn(`submit`,{output:t,annotations:v},!0);ce(n?`sent`:`failed`),W(()=>ce(`idle`),2500),n&&B.autoClearAfterCopy&&W(()=>Yn(),500)},[c,Hn,v,R,z,Je,et,V,B.outputDetail,`off`,B.autoClearAfterCopy,Yn]);(0,_.useEffect)(()=>{if(!on)return;let e=e=>{let t=e.clientX-on.x,n=e.clientY-on.y,r=Math.sqrt(t*t+n*n);if(!rn&&r>10&&an(!0),rn||r>10){let e=on.toolbarX+t,r=on.toolbarY+n,i=20-(337-(h?$t===`connected`?297:257:44)),a=window.innerWidth-20-337;e=Math.max(i,Math.min(a,e)),r=Math.max(20,Math.min(window.innerHeight-44-20,r)),nn({x:e,y:r})}},t=()=>{rn&&(cn.current=!0),an(!1),sn(null)};return document.addEventListener(`mousemove`,e),document.addEventListener(`mouseup`,t),()=>{document.removeEventListener(`mousemove`,e),document.removeEventListener(`mouseup`,t)}},[on,rn,h,$t]);let or=(0,_.useCallback)(e=>{if(e.target.closest(`button`)||e.target.closest(`[data-agentation-settings-panel]`))return;let t=e.currentTarget.parentElement;if(!t)return;let n=t.getBoundingClientRect(),r=tn?.x??n.left,i=tn?.y??n.top;sn({x:e.clientX,y:e.clientY,toolbarX:r,toolbarY:i})},[tn]);if((0,_.useEffect)(()=>{if(!tn)return;let e=()=>{let e=tn.x,t=tn.y,n=20-(337-(h?$t===`connected`?297:257:44)),r=window.innerWidth-20-337;e=Math.max(n,Math.min(r,e)),t=Math.max(20,Math.min(window.innerHeight-44-20,t)),(e!==tn.x||t!==tn.y)&&nn({x:e,y:t})};return e(),window.addEventListener(`resize`,e),()=>window.removeEventListener(`resize`,e)},[tn,h,$t]),(0,_.useEffect)(()=>{let e=e=>{let t=e.target,n=t.tagName===`INPUT`||t.tagName===`TEXTAREA`||t.isContentEditable;if(e.key===`Escape`){if(L){Ge?Ke(null):Fn();return}if(Et){Dt(!1);return}if(Lt.length>0){Rt([]);return}j||h&&(Bt(),g(!1))}if((e.metaKey||e.ctrlKey)&&e.shiftKey&&(e.key===`f`||e.key===`F`)){e.preventDefault(),Bt(),h?In():g(!0);return}if(!(n||e.metaKey||e.ctrlKey)&&((e.key===`p`||e.key===`P`)&&(e.preventDefault(),Bt(),zn()),(e.key===`l`||e.key===`L`)&&(e.preventDefault(),Bt(),Et&&Dt(!1),Ne&&Pe(!1),j&&Wn(),L?Fn():Ve(!0)),(e.key===`h`||e.key===`H`)&&v.length>0&&(e.preventDefault(),Bt(),S(e=>!e)),(e.key===`c`||e.key===`C`)&&(v.length>0||R.length>0||z)&&(e.preventDefault(),Bt(),Zn()),(e.key===`x`||e.key===`X`)&&(v.length>0||R.length>0||z)&&(e.preventDefault(),Bt(),Yn(),R.length>0&&We([]),z&&ot(null)),e.key===`s`||e.key===`S`)){let t=Zs(B.webhookUrl)||Zs(p||``);v.length>0&&t&&se===`idle`&&(e.preventDefault(),Bt(),ir())}};return document.addEventListener(`keydown`,e),()=>document.removeEventListener(`keydown`,e)},[h,Et,L,Ge,R,z,j,v.length,B.webhookUrl,p,se,ir,zn,Zn,Yn,Lt]),!I||C)return null;let sr=v.length>0,cr=v.filter(e=>!dn.has(e.id)&&e.kind!==`placement`&&e.kind!==`rearrange`),lr=cr.length>0,ur=v.filter(e=>dn.has(e.id)),fr=e=>{let t=e.x/100*window.innerWidth,n=typeof e.y==`string`?parseFloat(e.y):e.y,r={};window.innerHeight-n-22-10<80&&(r.top=`auto`,r.bottom=`calc(100% + 10px)`);let i=t-200/2;return i<10?r.left=`calc(50% + ${10-i}px)`:i+200>window.innerWidth-10&&(r.left=`calc(50% - ${i+200-(window.innerWidth-10)}px)`),r};return(0,y.createPortal)((0,H.jsxs)(`div`,{ref:E,style:{display:`contents`},"data-agentation-theme":Gt?`dark`:`light`,"data-agentation-accent":B.annotationColorId,"data-agentation-root":``,children:[(0,H.jsx)(`div`,{className:`${Z.toolbar}${m?` ${m}`:``}`,"data-feedback-toolbar":!0,"data-agentation-toolbar":!0,style:tn?{left:tn.x,top:tn.y,right:`auto`,bottom:`auto`}:void 0,children:(0,H.jsxs)(`div`,{className:`${Z.toolbarContainer} ${h?Z.expanded:Z.collapsed} ${qt?Z.entrance:``} ${ee?Z.hiding:``} ${!B.webhooksEnabled&&(Zs(B.webhookUrl)||Zs(p||``))?Z.serverConnected:``}`,onClick:h?void 0:e=>{if(cn.current){cn.current=!1,e.preventDefault();return}g(!0)},onMouseDown:or,role:h?void 0:`button`,tabIndex:h?-1:0,title:h?void 0:`Start feedback mode`,children:[(0,H.jsxs)(`div`,{className:`${Z.toggleContent} ${h?Z.hidden:Z.visible}`,children:[(0,H.jsx)(Xn,{size:24}),lr&&(0,H.jsx)(`span`,{className:`${Z.badge} ${h?Z.fadeOut:``} ${qt?Z.entrance:``}`,children:cr.length})]}),(0,H.jsxs)(`div`,{className:`${Z.controlsContent} ${h?Z.visible:Z.hidden} ${tn&&tn.y<100?Z.tooltipBelow:``} ${ze||Ne?Z.tooltipsHidden:``} ${Pt?Z.tooltipsInSession:``}`,onMouseEnter:Ht,onMouseLeave:Ut,children:[(0,H.jsxs)(`div`,{className:`${Z.buttonWrapper} ${tn&&tn.x<120?Z.buttonWrapperAlignLeft:``}`,children:[(0,H.jsx)(`button`,{className:Z.controlButton,onClick:e=>{e.stopPropagation(),Bt(),zn()},"data-active":je,children:(0,H.jsx)(tr,{size:24,isPaused:je})}),(0,H.jsxs)(`span`,{className:Z.buttonTooltip,children:[je?`Resume animations`:`Pause animations`,(0,H.jsx)(`span`,{className:Z.shortcut,children:`P`})]})]}),(0,H.jsxs)(`div`,{className:Z.buttonWrapper,children:[(0,H.jsx)(`button`,{className:`${Z.controlButton} ${Gt?``:Z.light}`,onClick:e=>{e.stopPropagation(),Bt(),Et&&Dt(!1),Ne&&Pe(!1),j&&Wn(),L?Fn():Ve(!0)},"data-active":L,style:L&&Je?{color:`#f97316`,background:`rgba(249, 115, 22, 0.25)`}:void 0,children:(0,H.jsx)(dr,{size:21})}),(0,H.jsxs)(`span`,{className:Z.buttonTooltip,children:[L?`Exit layout mode`:`Layout mode`,(0,H.jsx)(`span`,{className:Z.shortcut,children:`L`})]})]}),(0,H.jsxs)(`div`,{className:Z.buttonWrapper,children:[(0,H.jsx)(`button`,{className:Z.controlButton,onClick:e=>{e.stopPropagation(),Bt(),S(!x)},disabled:!sr||L,children:(0,H.jsx)(er,{size:24,isOpen:x})}),(0,H.jsxs)(`span`,{className:Z.buttonTooltip,children:[x?`Hide markers`:`Show markers`,(0,H.jsx)(`span`,{className:Z.shortcut,children:`H`})]})]}),(0,H.jsxs)(`div`,{className:Z.buttonWrapper,children:[(0,H.jsx)(`button`,{className:`${Z.controlButton} ${ae?Z.statusShowing:``}`,onClick:e=>{e.stopPropagation(),Bt(),Zn()},disabled:L&&Je?R.length===0&&!z?.sections?.length:!sr&&Ot.length===0&&R.length===0&&!z?.sections?.length,"data-active":ae,children:(0,H.jsx)(Qn,{size:24,copied:ae,tint:L&&Je&&(R.length>0||z?.sections?.length)?`#f97316`:void 0})}),(0,H.jsxs)(`span`,{className:Z.buttonTooltip,children:[L&&Je?`Copy layout`:`Copy feedback`,(0,H.jsx)(`span`,{className:Z.shortcut,children:`C`})]})]}),(0,H.jsxs)(`div`,{className:`${Z.buttonWrapper} ${Z.sendButtonWrapper} ${h&&!B.webhooksEnabled&&(Zs(B.webhookUrl)||Zs(p||``))?Z.sendButtonVisible:``}`,children:[(0,H.jsxs)(`button`,{className:`${Z.controlButton} ${se===`sent`||se===`failed`?Z.statusShowing:``}`,onClick:e=>{e.stopPropagation(),Bt(),ir()},disabled:!sr||!Zs(B.webhookUrl)&&!Zs(p||``)||se===`sending`,"data-no-hover":se===`sent`||se===`failed`,tabIndex:Zs(B.webhookUrl)||Zs(p||``)?0:-1,children:[(0,H.jsx)($n,{size:24,state:se}),sr&&se===`idle`&&(0,H.jsx)(`span`,{className:Z.buttonBadge,children:v.length})]}),(0,H.jsxs)(`span`,{className:Z.buttonTooltip,children:[`Send Annotations`,(0,H.jsx)(`span`,{className:Z.shortcut,children:`S`})]})]}),(0,H.jsxs)(`div`,{className:Z.buttonWrapper,children:[(0,H.jsx)(`button`,{className:Z.controlButton,onClick:e=>{e.stopPropagation(),Bt(),Yn()},disabled:!sr&&Ot.length===0&&R.length===0&&!z?.sections?.length,"data-danger":!0,children:(0,H.jsx)(rr,{size:24})}),(0,H.jsxs)(`span`,{className:Z.buttonTooltip,children:[`Clear all`,(0,H.jsx)(`span`,{className:Z.shortcut,children:`X`})]})]}),(0,H.jsxs)(`div`,{className:Z.buttonWrapper,children:[(0,H.jsx)(`button`,{className:Z.controlButton,onClick:e=>{e.stopPropagation(),Bt(),L&&Fn(),Pe(!Ne)},children:(0,H.jsx)(nr,{size:24})}),u&&$t!==`disconnected`&&(0,H.jsx)(`span`,{className:`${Z.mcpIndicator} ${Z[$t]} ${Ne?Z.hidden:``}`,title:$t===`connected`?`MCP Connected`:`MCP Connecting...`}),(0,H.jsx)(`span`,{className:Z.buttonTooltip,children:`Settings`})]}),(0,H.jsx)(`div`,{className:Z.divider}),(0,H.jsxs)(`div`,{className:`${Z.buttonWrapper} ${tn&&typeof window<`u`&&tn.x>window.innerWidth-120?Z.buttonWrapperAlignRight:``}`,children:[(0,H.jsx)(`button`,{className:Z.controlButton,onClick:e=>{e.stopPropagation(),Bt(),In()},children:(0,H.jsx)(ar,{size:24})}),(0,H.jsxs)(`span`,{className:Z.buttonTooltip,children:[`Exit`,(0,H.jsx)(`span`,{className:Z.shortcut,children:`Esc`})]})]})]}),(0,H.jsx)(ia,{visible:L&&h,activeType:Ge,onSelect:e=>{Ke(Ge===e?null:e)},isDarkMode:Gt,sectionCount:z?.sections.length??0,onDetectSections:()=>{let e=Na(),t=z?.sections??[],n=new Set(t.map(e=>e.selector)),r=e.filter(e=>!n.has(e.selector));ot({sections:[...t,...r],originalOrder:[...z?.originalOrder??[],...r.map(e=>e.id)],detectedAt:Date.now()})},placementCount:R.length,onClearPlacements:()=>{ht(e=>e+1),_t(e=>e+1),W(()=>{ot({sections:[],originalOrder:[],detectedAt:Date.now()})},200)},blankCanvas:Je,onBlankCanvasChange:e=>{let t={sections:[],originalOrder:[],detectedAt:Date.now()};e?(ct.current={rearrange:z,placements:R},ot(lt.current.rearrange||t),We(lt.current.placements),Ke(null)):(lt.current={rearrange:z,placements:R},ot(ct.current.rearrange||t),We(ct.current.placements)),Ye(e)},wireframePurpose:nt,onWireframePurposeChange:rt,Tooltip:Or,onDragStart:(e,t)=>{t.preventDefault();let n=G[e],r=null,i=!1,a=t.clientX,o=t.clientY,s=t.target.closest(`[data-feedback-toolbar]`)?.getBoundingClientRect().top??window.innerHeight,c=t=>{let c=t.clientX-a,l=t.clientY-o;if(!i&&(Math.abs(c)>4||Math.abs(l)>4)&&(i=!0,r=document.createElement(`div`),r.className=`${q.dragPreview}${Je?` ${q.dragPreviewWireframe}`:``}`,document.body.appendChild(r)),!r)return;let u=Math.max(0,s-t.clientY),d=1-(1-Math.min(1,u/180))**2,f=Math.min(140,n.width*.18),p=Math.min(90,n.height*.18),m=28+(f-28)*d,h=20+(p-20)*d;r.style.width=`${m}px`,r.style.height=`${h}px`,r.style.left=`${t.clientX-m/2}px`,r.style.top=`${t.clientY-h/2}px`,r.style.opacity=`${.5+.5*d}`,r.textContent=d>.25?e:``},l=t=>{if(window.removeEventListener(`mousemove`,c),window.removeEventListener(`mouseup`,l),r&&document.body.removeChild(r),i){let r=n.width,i=n.height,a=window.scrollY,o=Math.max(0,t.clientX-r/2),s=Math.max(0,t.clientY+a-i/2),c={id:`dp-${Date.now()}-${Math.random().toString(36).slice(2,7)}`,type:e,x:o,y:s,width:r,height:i,scrollY:a,timestamp:Date.now()};We(e=>[...e,c]),Ke(null),vt.current=new Set,dt(e=>e+1)}};window.addEventListener(`mousemove`,c),window.addEventListener(`mouseup`,l)}}),(0,H.jsx)(qs,{settings:B,onSettingsChange:e=>Wt(t=>({...t,...e})),isDarkMode:Gt,onToggleTheme:Yt,isDevMode:!1,connectionStatus:$t,endpoint:u,isVisible:Fe,toolbarNearBottom:!!tn&&tn.y<230,settingsPage:Le,onSettingsPageChange:Re,onHideToolbar:Mn})]})}),(L||He)&&(0,H.jsx)(`div`,{className:`${q.blankCanvas} ${Xe?q.visible:``} ${it?q.gridActive:``}`,style:{"--canvas-opacity":Qe},"data-feedback-toolbar":!0}),L&&Je&&Xe&&(0,H.jsxs)(`div`,{className:q.wireframeNotice,"data-feedback-toolbar":!0,children:[(0,H.jsxs)(`div`,{className:q.wireframeOpacityRow,children:[(0,H.jsx)(`span`,{className:q.wireframeOpacityLabel,children:`Toggle Opacity`}),(0,H.jsx)(`input`,{type:`range`,className:q.wireframeOpacitySlider,min:0,max:1,step:.01,value:Qe,onChange:e=>$e(Number(e.target.value))})]}),(0,H.jsxs)(`div`,{className:q.wireframeNoticeTitleRow,children:[(0,H.jsx)(`span`,{className:q.wireframeNoticeTitle,children:`Wireframe Mode`}),(0,H.jsx)(`span`,{className:q.wireframeNoticeDivider}),(0,H.jsx)(`button`,{className:q.wireframeStartOver,onClick:()=>{ht(e=>e+1),ot({sections:[],originalOrder:[],detectedAt:Date.now()}),lt.current={rearrange:null,placements:[]},rt(``),Oo(V)},children:`Start Over`})]}),`Drag components onto the canvas.`,(0,H.jsx)(`br`,{}),`Copied output will only include the wireframed layout.`]}),(L||He)&&(0,H.jsx)($i,{placements:R,onChange:We,activeComponent:He?null:Ge,onActiveComponentChange:Ke,isDarkMode:Gt,exiting:He,onInteractionChange:at,passthrough:!Ge,extraSnapRects:z?.sections.map(e=>e.currentRect),deselectSignal:ut,clearSignal:mt,wireframe:Je,onSelectionChange:(e,t)=>{vt.current=e,t||(yt.current=new Set,pt(e=>e+1))},onDragMove:(e,t)=>{let n=yt.current;if(!(!n.size||!z)){if(!bt.current){bt.current=new Map;for(let e of z.sections)n.has(e.id)&&bt.current.set(e.id,{x:e.currentRect.x,y:e.currentRect.y})}for(let r of z.sections){if(!n.has(r.id)||!bt.current.get(r.id))continue;let i=document.querySelector(`[data-rearrange-section="${r.id}"]`);i&&(i.style.transform=`translate(${e}px, ${t}px)`)}}},onDragEnd:(e,t,n)=>{let r=yt.current,i=bt.current;if(bt.current=null,!(!r.size||!z||!i)){for(let e of r){let t=document.querySelector(`[data-rearrange-section="${e}"]`);t&&(t.style.transform=``)}n&&ot(n=>n&&{...n,sections:n.sections.map(n=>{let r=i.get(n.id);return r?{...n,currentRect:{...n.currentRect,x:Math.max(0,r.x+e),y:Math.max(0,r.y+t)}}:n})})}}}),(L||He)&&z&&(0,H.jsx)(Ua,{rearrangeState:z,onChange:ot,isDarkMode:Gt,exiting:He,blankCanvas:Je,extraSnapRects:R.map(e=>({x:e.x,y:e.y,width:e.width,height:e.height})),clearSignal:gt,deselectSignal:ft,onSelectionChange:(e,t)=>{yt.current=e,t||(vt.current=new Set,dt(e=>e+1))},onDragMove:(e,t)=>{let n=vt.current;if(n.size){if(!bt.current){bt.current=new Map;for(let e of R)n.has(e.id)&&bt.current.set(e.id,{x:e.x,y:e.y})}for(let r of n){let n=document.querySelector(`[data-design-placement="${r}"]`);n&&(n.style.transform=`translate(${e}px, ${t}px)`)}}},onDragEnd:(e,t,n)=>{let r=vt.current,i=bt.current;if(bt.current=null,!(!r.size||!i)){for(let e of r){let t=document.querySelector(`[data-design-placement="${e}"]`);t&&(t.style.transform=``)}n&&We(n=>n.map(n=>{let r=i.get(n.id);return r?{...n,x:Math.max(0,r.x+e),y:Math.max(0,r.y+t)}:n}))}}}),(0,H.jsx)(`canvas`,{ref:Nt,className:`${Z.drawCanvas} ${Et?Z.active:``}`,style:{opacity:+!!An,transition:`opacity 0.15s ease`},"data-feedback-toolbar":!0}),(0,H.jsxs)(`div`,{className:Z.markersLayer,"data-feedback-toolbar":!0,children:[D&&cr.filter(e=>!e.isFixed).map((e,t,n)=>(0,H.jsx)(As,{annotation:e,globalIndex:cr.findIndex(t=>t.id===e.id),layerIndex:t,layerSize:n.length,isExiting:te,isClearing:P,isAnimated:ln.has(e.id),isHovered:!te&&de===e.id,isDeleting:_e===e.id,isEditingAny:!!F,renumberFrom:ye,markerClickBehavior:B.markerClickBehavior,tooltipStyle:fr(e),onHoverEnter:e=>!te&&e.id!==Tn.current&&Kn(e),onHoverLeave:()=>Kn(null),onClick:e=>B.markerClickBehavior===`delete`?Gn(e.id):Vn(e),onContextMenu:Vn},e.id)),D&&!te&&ur.filter(e=>!e.isFixed).map(e=>(0,H.jsx)(Ms,{annotation:e},e.id))]}),(0,H.jsxs)(`div`,{className:Z.fixedMarkersLayer,"data-feedback-toolbar":!0,children:[D&&cr.filter(e=>e.isFixed).map((e,t,n)=>(0,H.jsx)(As,{annotation:e,globalIndex:cr.findIndex(t=>t.id===e.id),layerIndex:t,layerSize:n.length,isExiting:te,isClearing:P,isAnimated:ln.has(e.id),isHovered:!te&&de===e.id,isDeleting:_e===e.id,isEditingAny:!!F,renumberFrom:ye,markerClickBehavior:B.markerClickBehavior,tooltipStyle:fr(e),onHoverEnter:e=>!te&&e.id!==Tn.current&&Kn(e),onHoverLeave:()=>Kn(null),onClick:e=>B.markerClickBehavior===`delete`?Gn(e.id):Vn(e),onContextMenu:Vn},e.id)),D&&!te&&ur.filter(e=>e.isFixed).map(e=>(0,H.jsx)(Ms,{annotation:e,fixed:!0},e.id))]}),h&&(0,H.jsxs)(`div`,{className:Z.overlay,"data-feedback-toolbar":!0,style:j||F?{zIndex:99999}:void 0,children:[k?.rect&&!j&&!Oe&&!_n&&(0,H.jsx)(`div`,{className:`${Z.hoverHighlight} ${Z.enter}`,style:{left:k.rect.left,top:k.rect.top,width:k.rect.width,height:k.rect.height,borderColor:`color-mix(in srgb, var(--agentation-color-accent) 50%, transparent)`,backgroundColor:`color-mix(in srgb, var(--agentation-color-accent) 4%, transparent)`}}),Lt.filter(e=>document.contains(e.element)).map((e,t)=>{let n=e.element.getBoundingClientRect(),r=Lt.length>1;return(0,H.jsx)(`div`,{className:r?Z.multiSelectOutline:Z.singleSelectOutline,style:{position:`fixed`,left:n.left,top:n.top,width:n.width,height:n.height,...r?{}:{borderColor:`color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)`,backgroundColor:`color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)`}}},t)}),de&&!j&&(()=>{let e=v.find(e=>e.id===de);if(!e?.boundingBox)return null;if(e.elementBoundingBoxes?.length)return he.length>0?he.filter(e=>document.contains(e)).map((e,t)=>{let n=e.getBoundingClientRect();return(0,H.jsx)(`div`,{className:`${Z.multiSelectOutline} ${Z.enter}`,style:{left:n.left,top:n.top,width:n.width,height:n.height}},`hover-outline-live-${t}`)}):e.elementBoundingBoxes.map((e,t)=>(0,H.jsx)(`div`,{className:`${Z.multiSelectOutline} ${Z.enter}`,style:{left:e.x,top:e.y-Ee,width:e.width,height:e.height}},`hover-outline-${t}`));let t=pe&&document.contains(pe)?pe.getBoundingClientRect():null,n=t?{x:t.left,y:t.top,width:t.width,height:t.height}:{x:e.boundingBox.x,y:e.isFixed?e.boundingBox.y:e.boundingBox.y-Ee,width:e.boundingBox.width,height:e.boundingBox.height},r=e.isMultiSelect;return(0,H.jsx)(`div`,{className:`${r?Z.multiSelectOutline:Z.singleSelectOutline} ${Z.enter}`,style:{left:n.x,top:n.y,width:n.width,height:n.height,...r?{}:{borderColor:`color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)`,backgroundColor:`color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)`}}})})(),k&&!j&&!Oe&&!_n&&(0,H.jsxs)(`div`,{className:`${Z.hoverTooltip} ${Z.enter}`,style:{left:Math.max(8,Math.min(re.x,window.innerWidth-100)),top:Math.max(re.y-(k.reactComponents?48:32),8)},children:[k.reactComponents&&(0,H.jsx)(`div`,{className:Z.hoverReactPath,children:k.reactComponents}),(0,H.jsx)(`div`,{className:Z.hoverElementName,children:k.elementName})]}),j&&(0,H.jsxs)(H.Fragment,{children:[j.multiSelectElements?.length?j.multiSelectElements.filter(e=>document.contains(e)).map((e,t)=>{let n=e.getBoundingClientRect();return(0,H.jsx)(`div`,{className:`${Z.multiSelectOutline} ${pn?Z.exit:Z.enter}`,style:{left:n.left,top:n.top,width:n.width,height:n.height}},`pending-multi-${t}`)}):j.targetElement&&document.contains(j.targetElement)?(()=>{let e=j.targetElement.getBoundingClientRect();return(0,H.jsx)(`div`,{className:`${Z.singleSelectOutline} ${pn?Z.exit:Z.enter}`,style:{left:e.left,top:e.top,width:e.width,height:e.height,borderColor:`color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)`,backgroundColor:`color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)`}})})():j.boundingBox&&(0,H.jsx)(`div`,{className:`${j.isMultiSelect?Z.multiSelectOutline:Z.singleSelectOutline} ${pn?Z.exit:Z.enter}`,style:{left:j.boundingBox.x,top:j.boundingBox.y-Ee,width:j.boundingBox.width,height:j.boundingBox.height,...j.isMultiSelect?{}:{borderColor:`color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)`,backgroundColor:`color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)`}}}),(()=>{let e=j.x,t=j.isFixed?j.y:j.y-Ee;return(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(js,{x:e,y:t,isMultiSelect:j.isMultiSelect,isExiting:pn}),(0,H.jsx)(Cr,{ref:Dn,element:j.element,selectedText:j.selectedText,computedStyles:j.computedStylesObj,placeholder:j.element===`Area selection`?`What should change in this area?`:j.isMultiSelect?`Feedback for this group of elements...`:`What should change?`,onSubmit:Un,onCancel:Wn,isExiting:pn,lightMode:!Gt,accentColor:j.isMultiSelect?`var(--agentation-color-green)`:`var(--agentation-color-accent)`,style:{left:Math.max(160,Math.min(window.innerWidth-160,e/100*window.innerWidth)),...t>window.innerHeight-290?{bottom:window.innerHeight-t+20}:{top:t+20}}})]})})()]}),F&&(0,H.jsxs)(H.Fragment,{children:[F.elementBoundingBoxes?.length?we.length>0?we.filter(e=>document.contains(e)).map((e,t)=>{let n=e.getBoundingClientRect();return(0,H.jsx)(`div`,{className:`${Z.multiSelectOutline} ${Z.enter}`,style:{left:n.left,top:n.top,width:n.width,height:n.height}},`edit-multi-live-${t}`)}):F.elementBoundingBoxes.map((e,t)=>(0,H.jsx)(`div`,{className:`${Z.multiSelectOutline} ${Z.enter}`,style:{left:e.x,top:e.y-Ee,width:e.width,height:e.height}},`edit-multi-${t}`)):(()=>{let e=Se&&document.contains(Se)?Se.getBoundingClientRect():null,t=e?{x:e.left,y:e.top,width:e.width,height:e.height}:F.boundingBox?{x:F.boundingBox.x,y:F.isFixed?F.boundingBox.y:F.boundingBox.y-Ee,width:F.boundingBox.width,height:F.boundingBox.height}:null;return t?(0,H.jsx)(`div`,{className:`${F.isMultiSelect?Z.multiSelectOutline:Z.singleSelectOutline} ${Z.enter}`,style:{left:t.x,top:t.y,width:t.width,height:t.height,...F.isMultiSelect?{}:{borderColor:`color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)`,backgroundColor:`color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)`}}}):null})(),(0,H.jsx)(Cr,{ref:On,element:F.element,selectedText:F.selectedText,computedStyles:ba(F.computedStyles),placeholder:`Edit your feedback...`,initialValue:F.comment,submitLabel:`Save`,onSubmit:qn,onCancel:Jn,onDelete:()=>Gn(F.id),isExiting:hn,lightMode:!Gt,accentColor:F.isMultiSelect?`var(--agentation-color-green)`:`var(--agentation-color-accent)`,style:(()=>{let e=F.isFixed?F.y:F.y-Ee;return{left:Math.max(160,Math.min(window.innerWidth-160,F.x/100*window.innerWidth)),...e>window.innerHeight-290?{bottom:window.innerHeight-e+20}:{top:e+20}}})()})]}),_n&&(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(`div`,{ref:xn,className:Z.dragSelection}),(0,H.jsx)(`div`,{ref:Sn,className:Z.highlightsContainer})]})]})]}),document.body)}var ic=[{name:`Layout`,elements:[{type:`div`,label:`Container`,icon:`□`,isField:!1,defaultProps:{class:`uib-container`}},{type:`div`,label:`Plain Div`,icon:`□`,isField:!1,defaultProps:{class:``}},{type:`div`,label:`Row`,icon:`⊞`,isField:!1,defaultProps:{class:`uib-row`}},{type:`div`,label:`Column`,icon:`⊞`,isField:!1,defaultProps:{class:`uib-col-12`}},{type:`section`,label:`Section`,icon:`📑`,isField:!1,defaultProps:{class:`uib-section`}},{type:`article`,label:`Article`,icon:`📄`,isField:!1,defaultProps:{class:`uib-article`}},{type:`main`,label:`Main`,icon:`🔲`,isField:!1,defaultProps:{class:`uib-main`}},{type:`aside`,label:`Aside`,icon:`◧`,isField:!1,defaultProps:{class:`uib-aside`}},{type:`nav`,label:`Navigation`,icon:`⟁`,isField:!1,defaultProps:{class:`uib-nav`}},{type:`div`,label:`Grid`,icon:`⊞`,isField:!1,defaultProps:{class:`uib-grid`}}]},{name:`Media`,elements:[{type:`img`,label:`Image`,icon:`🖼`,isField:!0,defaultProps:{class:`uib-img`}},{type:`svg`,label:`SVG`,icon:`S`,isField:!0,defaultProps:{class:`uib-svg`}},{type:`video`,label:`Video`,icon:`▶`,isField:!0,defaultProps:{class:``}}]},{name:`Typography`,elements:[{type:`h1`,label:`Heading 1`,icon:`H1`,isField:!0,defaultProps:{class:`uib-h1`},defaultContent:`Heading 1`},{type:`h2`,label:`Heading 2`,icon:`H2`,isField:!0,defaultProps:{class:`uib-h2`},defaultContent:`Heading 2`},{type:`h3`,label:`Heading 3`,icon:`H3`,isField:!0,defaultProps:{class:`uib-h3`},defaultContent:`Heading 3`},{type:`h4`,label:`Heading 4`,icon:`H4`,isField:!0,defaultProps:{class:`uib-h4`},defaultContent:`Heading 4`},{type:`h5`,label:`Heading 5`,icon:`H5`,isField:!0,defaultProps:{class:`uib-h5`},defaultContent:`Heading 5`},{type:`h6`,label:`Heading 6`,icon:`H6`,isField:!0,defaultProps:{class:`uib-h6`},defaultContent:`Heading 6`},{type:`p`,label:`Paragraph`,icon:`¶`,isField:!0,defaultProps:{class:`uib-p`},defaultContent:`This is a paragraph of text.`},{type:`blockquote`,label:`Quote`,icon:`“`,isField:!0,defaultProps:{class:`uib-blockquote`},defaultContent:`Enter your quote here.`},{type:`hr`,label:`Divider`,icon:`—`,isField:!0,defaultProps:{class:`uib-hr`}}]},{name:`Inline`,elements:[{type:`span`,label:`Span / Text`,icon:`T`,isField:!0,defaultProps:{class:`uib-span`},defaultContent:`Inline text`},{type:`strong`,label:`Bold`,icon:`B`,isField:!0,defaultProps:{class:`uib-strong`},defaultContent:`Bold text`},{type:`em`,label:`Italic`,icon:`I`,isField:!0,defaultProps:{class:`uib-em`},defaultContent:`Italic text`},{type:`code`,label:`Code`,icon:`</>`,isField:!0,defaultProps:{class:`uib-code`},defaultContent:`code_here()`},{type:`small`,label:`Small`,icon:`s`,isField:!0,defaultProps:{class:`uib-small`},defaultContent:`Small text`}]},{name:`Tables`,elements:[{type:`table`,label:`Table`,icon:`▦`,isField:!1,defaultProps:{class:`uib-table`},defaultChildren:[{type:`thead`,label:`Table Head`,children:[{type:`tr`,label:`Table Row`,children:[{type:`th`,label:`Table Cell`,content:`Header 1`,isField:!0},{type:`th`,label:`Table Cell`,content:`Header 2`,isField:!0},{type:`th`,label:`Table Cell`,content:`Header 3`,isField:!0}]}]},{type:`tbody`,label:`Table Body`,children:[{type:`tr`,label:`Table Row`,children:[{type:`td`,label:`Table Cell`,content:`Data 1`,isField:!0},{type:`td`,label:`Table Cell`,content:`Data 2`,isField:!0},{type:`td`,label:`Table Cell`,content:`Data 3`,isField:!0}]}]}]},{type:`tr`,label:`Table Row`,icon:`=`,isField:!1},{type:`td`,label:`Table Cell`,icon:`□`,isField:!0,defaultContent:`Cell data`},{type:`thead`,label:`Table Head`,icon:`☰`,isField:!1},{type:`tbody`,label:`Table Body`,icon:`☰`,isField:!1}]},{name:`Lists`,elements:[{type:`ul`,label:`Unordered List`,icon:`•`,isField:!1,defaultProps:{class:`uib-ul`},defaultChildren:[{type:`li`,label:`List Item`,props:{class:`uib-li`},content:`New list item`,isField:!0}]},{type:`ol`,label:`Ordered List`,icon:`1.`,isField:!1,defaultProps:{class:`uib-ol`},defaultChildren:[{type:`li`,label:`List Item`,props:{class:`uib-li`},content:`New list item`,isField:!0}]},{type:`li`,label:`List Item`,icon:`-`,isField:!0,defaultProps:{class:`uib-li`},defaultContent:`List item`}]},{name:`Forms`,elements:[{type:`form`,label:`Form`,icon:`✉`,isField:!1,defaultProps:{class:`uib-form`},defaultChildren:[{type:`label`,label:`Label`,content:`Email Address`,isField:!0,props:{class:`uib-label`}},{type:`input`,label:`Input`,isField:!0,props:{class:`uib-input`,type:`email`,placeholder:`Enter email...`}},{type:`button`,label:`Submit`,content:`Submit`,isField:!0,props:{class:`uib-button uib-submit`,type:`submit`}}]},{type:`label`,label:`Label`,icon:`T`,isField:!0,defaultProps:{class:`uib-label`},defaultContent:`Field Label`},{type:`input`,label:`Input Field`,icon:`✎`,isField:!0,defaultProps:{class:`uib-input`,type:`text`}},{type:`select`,label:`Select Dropdown`,icon:`▾`,isField:!1,defaultProps:{class:`uib-select`},defaultChildren:[{type:`option`,label:`Select Option`,content:`Select an option...`,isField:!0}]},{type:`option`,label:`Select Option`,icon:`○`,isField:!0,defaultContent:`Option`},{type:`textarea`,label:`Textarea`,icon:`¶`,isField:!0,defaultProps:{class:`uib-textarea`}}]},{name:`Interactive`,elements:[{type:`button`,label:`Button`,icon:`▢`,isField:!0,defaultProps:{class:`uib-button`},defaultContent:`Click Me`},{type:`a`,label:`Link`,icon:`⟁`,isField:!0,defaultProps:{class:`uib-link`},defaultContent:`Read more`}]},{name:`Drupal`,elements:[{type:`drupal-block`,label:`Block`,icon:`☐`,isField:!1,isDrupal:!0,defaultProps:{"block-id":``,class:``}},{type:`drupal-menu`,label:`Menu`,icon:`☰`,isField:!1,isDrupal:!0,defaultProps:{"menu-name":``,class:``}}]}],ac=[`div`,`section`,`article`,`header`,`footer`,`main`,`aside`,`nav`,`ul`,`ol`,`table`,`thead`,`tbody`,`tr`,`form`,`select`],oc=(e,t)=>{let n=null;for(let r of ic)if(n=r.elements.find(n=>n.type===e&&n.label===t),n)break;return n?.defaultProps?.class||``},sc=e=>e?e.split(/\s+/).filter(Boolean):[],cc=(e,t,n)=>{let r=sc(oc(t,n));return sc(e).filter(e=>!r.includes(e)).join(` `)};function lc(e){return JSON.parse(JSON.stringify(e))}function uc(e,t){for(let n of e){if(n.id===t)return n;if(n.children){let e=uc(n.children,t);if(e)return e}}return null}function dc(e,t){for(let n=0;n<e.length;n++){if(e[n].id===t)return{parent:e,index:n};if(e[n].children){let r=dc(e[n].children,t);if(r)return r}}return null}var fc=e=>{if(typeof e!=`string`)return e;let t=e,n=t.indexOf(`{`),r=t.lastIndexOf(`}`);return n!==-1&&r!==-1&&r>n&&(t=t.substring(0,n)+t.substring(r+1)),t.replace(/\{\s*\{[\s\S]*?\}\s*\}/g,``).replace(/:\s*$/,``).trim()},pc=e=>{if(!e)return e;let t=typeof e==`string`?JSON.parse(e):e;if(typeof t!=`object`)return e;let n={...t};return Object.keys(n).forEach(e=>{n[e]&&n[e].title&&(n[e].title=fc(n[e].title),n[e].title||(n[e].title=`${e} Field`))}),typeof e==`string`?JSON.stringify(n):n};function mc(e){return e.map(e=>{let t=e.label;t&&(t=fc(t),t||=e.tag?e.tag.charAt(0).toUpperCase()+e.tag.slice(1):`Element`);let n=e.content;return typeof n==`string`&&(n=fc(n)),{...e,label:t,content:n,props:e.props||{},children:e.children?mc(e.children):e.isField?void 0:[]}})}function hc(e,t){return e.filter(e=>e.id!==t).map(e=>({...e,children:e.children?hc(e.children,t):[]}))}function gc(e,t){if(!e)return!0;if(!ac.includes(e.tag))return!1;let n=t.type||t.tag;return!((e.tag===`ul`||e.tag===`ol`)&&n!==`li`||e.tag===`table`&&![`thead`,`tbody`,`tr`].includes(n)||[`thead`,`tbody`].includes(e.tag)&&n!==`tr`||e.tag===`tr`&&![`th`,`td`].includes(n)||[`th`,`td`].includes(n)&&e.tag!==`tr`||e.tag===`select`&&n!==`option`||[`section`,`header`,`footer`,`main`].includes(n)&&![`div`,`main`].includes(e.tag))}function _c(e){if(!e)return!1;let t=e.label||``,n=t.startsWith(`Container`)||t.startsWith(`Plain Div`)||e.tag===`div`,r=e=>e?!!(e.properties&&Object.values(e.properties).some(e=>e&&e.trim()!==``)||e.custom_properties&&Object.values(e.custom_properties).some(e=>e&&e.trim()!==``)||e.children&&e.children.some(e=>r(e))):!1;if(n&&e.instanceStyles&&r(e.instanceStyles))return!0;if(!e.props)return!1;let i=e.props;return!!(!e.props?.class?.split(` `).some(e=>e.startsWith(`uib-col-`))&&(i.flexDirection||i.justifyContent||i.alignItems||i.alignSelf||i.flexGrow!==void 0&&i.flexGrow!==0||i.flexShrink!==void 0&&i.flexShrink!==1||i.width||i.height))}function vc(e,t,n=null){for(let r of e){let e=r.component_id?r:n;if(r.id===t)return e;if(r.children){let n=vc(r.children,t,e);if(n)return n}}return null}function yc(e,t){!e||!Array.isArray(e)||e.forEach(e=>{e.originalContent===void 0&&(e.originalContent=e.content===void 0?``:e.content),e.originalProps===void 0&&(e.originalProps=e.props?{...e.props}:{}),e.originalId===void 0&&(e.originalId=e.id);let n=null;if(e.fieldLabel?n=e.fieldLabel.toLowerCase().replace(/\s+/g,`_`).replace(/[^\w]/g,``):e.originalId&&(n=`field_`+e.originalId),n&&t&&t[n]!==void 0){let r=t[n],i;i=r&&typeof r==`object`&&`value`in r?r.value:r==null?``:String(r),e.content=i}else e.content=e.originalContent;if(e.props)for(let n of Object.keys(e.originalProps)){let r=e.originalProps[n];if(typeof r==`string`){let i=r;if(t)for(let[e,n]of Object.entries(t)){let t=n&&typeof n==`object`&&`value`in n?n.value:String(n||``);i=i.replace(RegExp(`\\{\\{\\s*${e}\\s*\\}\\}`,`g`),t)}e.props[n]=i}else e.props[n]=r}e.children&&Array.isArray(e.children)&&yc(e.children,t)})}function bc({node:e,mode:t,selectedId:n,onSelect:r,onOpenProperties:i,onDuplicate:a,onDelete:o,onQuickAdd:s,onStartTargetedAdd:c,onSaveAsComponent:l,pendingParentId:u,availableComponents:d,depth:f=0,isInherited:p=!1,isRow:m=!1}){let{attributes:h,listeners:g,setNodeRef:_,isDragging:v}=Tn({id:e.id,disabled:p});return(0,H.jsx)(Ec,{node:e,mode:t,selectedId:n,onSelect:r,onOpenProperties:i,onDuplicate:a,onDelete:o,onQuickAdd:s,onStartTargetedAdd:c,onSaveAsComponent:l,pendingParentId:u,availableComponents:d,isDragging:v,attributes:h,listeners:g,setNodeRef:_,style:{opacity:v?.3:1,position:`relative`},depth:f,isInherited:p,isRow:m})}var xc=(0,_.createContext)({isDraggingGlobal:!1});function Sc(){return(0,_.useContext)(xc)}function Cc({parentId:e,index:t,isActive:n}){let{setNodeRef:r,isOver:i}=kn({id:`gap::${e}::${t}`});return(0,H.jsx)(`div`,{ref:r,className:`ss-drop-gap ${i?`ss-drop-gap-active`:``} ${n?`ss-drop-gap-visible`:``}`})}function wc({parentNode:e,mode:t,selectedId:n,onSelect:r,onOpenProperties:i,onDuplicate:a,onDelete:o,onQuickAdd:s,onStartTargetedAdd:c,onSaveAsComponent:l,pendingParentId:u,availableComponents:d,depth:f=0,isInherited:p=!1,isRow:m=!1}){let{isDraggingGlobal:h}=Sc(),g=e.children||[];return m?(0,H.jsxs)(`div`,{className:`ss-box-columns-wrap ${e.props?.class||`uib-row`} ${_c(e)?`uib-${e.id}`:``}`,children:[g.map((m,g)=>(0,H.jsxs)(`div`,{className:`ss-box-col-slot ${(m.props?.class||``).split(/\s+/).find(e=>e.startsWith(`uib-col-`))||`uib-col-12`} ${_c(m)?`uib-${m.id}`:``}`,children:[h&&!p&&(0,H.jsx)(Cc,{parentId:e.id,index:g,isActive:h}),(0,H.jsx)(bc,{node:m,mode:t,selectedId:n,onSelect:r,onOpenProperties:i,onDuplicate:a,onDelete:o,onQuickAdd:s,onStartTargetedAdd:c,onSaveAsComponent:l,pendingParentId:u,availableComponents:d,depth:f,isInherited:p})]},m.id)),h&&!p&&(0,H.jsx)(Cc,{parentId:e.id,index:g.length,isActive:h}),!p&&(0,H.jsx)(`div`,{className:`ss-box-empty-drop-area ${h?`ss-box-empty-drop-area-visible`:``}`,style:{width:`100%`}})]}):(0,H.jsxs)(`div`,{className:`ss-box-children-wrap`,children:[g.map((m,g)=>(0,H.jsxs)(`div`,{className:`ss-drop-slot`,children:[h&&!p&&(0,H.jsx)(Cc,{parentId:e.id,index:g,isActive:h}),(0,H.jsx)(bc,{node:m,mode:t,selectedId:n,onSelect:r,onOpenProperties:i,onDuplicate:a,onDelete:o,onQuickAdd:s,onStartTargetedAdd:c,onSaveAsComponent:l,pendingParentId:u,availableComponents:d,depth:f,isInherited:p})]},m.id)),h&&!p&&(0,H.jsx)(Cc,{parentId:e.id,index:g.length,isActive:h}),!p&&(0,H.jsx)(`div`,{className:`ss-box-empty-drop-area ${h?`ss-box-empty-drop-area-visible`:``}`})]})}function Tc(e,t,n){if(n)return{icon:`🧩`,color:`#a855f7`};let r=t||e||``;return r.startsWith(`Container`)||r.startsWith(`Plain Div`)||r.startsWith(`Section`)||r.startsWith(`Row`)||r.startsWith(`Column`)||e===`div`||e===`main`||e===`aside`||e===`article`||e===`nav`?e===`aside`?{icon:`◧`,color:`#fbbf24`}:e===`article`?{icon:`📄`,color:`#d97706`}:e===`section`?{icon:`📑`,color:`#f5a623`}:e===`main`?{icon:`🔲`,color:`#f5a623`}:e===`nav`?{icon:`⟁`,color:`#f5a623`}:{icon:`□`,color:`#f5a623`}:r===`Image`?{icon:`🖼`,color:`#0073ba`}:e===`svg`?{icon:`S`,color:`#0073ba`}:r===`Video`?{icon:`▶`,color:`#0073ba`}:r.startsWith(`Heading`)||r.startsWith(`Header`)?{icon:`H`,color:`#0073ba`}:r===`WYSIWYG`||r===`Paragraph`||e===`p`?{icon:`¶`,color:`#0073ba`}:r===`Link`||e===`a`?{icon:`🔗`,color:`#0073ba`}:r===`Button`||e===`button`?{icon:`▢`,color:`#0073ba`}:e===`ul`||e===`ol`?{icon:`≡`,color:`#0073ba`}:e===`li`?{icon:`•`,color:`#0073ba`}:e===`table`?{icon:`▦`,color:`#10b981`}:[`thead`,`tbody`].includes(e)?{icon:`☰`,color:`#10b981`}:e===`tr`?{icon:`＝`,color:`#10b981`}:[`th`,`td`].includes(e)?{icon:`▫`,color:`#10b981`}:e===`form`?{icon:`✉`,color:`#f43f5e`}:e===`label`?{icon:`L`,color:`#f43f5e`}:[`input`,`textarea`,`select`].includes(e)?{icon:`✎`,color:`#f43f5e`}:e===`option`?{icon:`○`,color:`#f43f5e`}:{icon:`📄`,color:`#0073ba`}}function Ec({node:e,mode:t,selectedId:n,onSelect:r,onOpenProperties:i,onDuplicate:a,onDelete:o,onQuickAdd:s,onStartTargetedAdd:c,onSaveAsComponent:l,pendingParentId:u,availableComponents:d,isOverlay:f,isDragging:p,attributes:m,listeners:h,setNodeRef:g,style:v,depth:y=0,isInherited:b=!1}){let{isDraggingGlobal:x}=Sc(),S=!!e.component_id,C=ac.includes(e.tag)||e.children&&e.children.length>0,{setNodeRef:w,isOver:ee}=kn({id:`inside::${e.id}`,disabled:!C||p||b||S}),[T,E]=(0,_.useState)(!1),[D,O]=(0,_.useState)(!1),te=(0,_.useRef)(null);(0,_.useEffect)(()=>{let e=e=>{te.current&&!te.current.contains(e.target)&&O(!1)};return document.addEventListener(`mousedown`,e),()=>document.removeEventListener(`mousedown`,e)},[D]),(0,_.useEffect)(()=>{let e=()=>E(!0),t=()=>E(!1);return window.addEventListener(`ss-collapse-all`,e),window.addEventListener(`ss-expand-all`,t),()=>{window.removeEventListener(`ss-collapse-all`,e),window.removeEventListener(`ss-expand-all`,t)}},[]);let ne=n===e.id,k=e.label===`Row for columns`||e.label&&e.label.startsWith(`Row`),A=e.label===`Column`,re=ee&&C&&!p&&x,ie=S?e.label||`Component`:e.label||(e.tag?e.tag.charAt(0).toUpperCase()+e.tag.slice(1):`Element`);if(A){let t,n=e.instanceStyles?.custom_properties?.[`max-width`];if(n){let e=parseFloat(n.replace(`%`,``));t=Math.round(e/100*12).toString()}else t=((e.props?.class||``).split(/\s+/).find(e=>e.startsWith(`uib-col-`))||`uib-col-12`).replace(`uib-col-`,``);ie=`${ie} (${t}/12)`}else if(k){let t=e.props?.flexDirection;t&&t!==`row`&&(ie=`${ie} (${t.charAt(0).toUpperCase()+t.slice(1)})`)}let j=Tc(e.tag,ie,S);return(0,H.jsxs)(`div`,{ref:g,style:{...v,touchAction:`none`},className:`
      ...
      `,onClick:t=>{t.stopPropagation(),r(e.id)},onDoubleClick:t=>{t.stopPropagation(),i&&i(e.id)},children:[(0,H.jsxs)(`div`,{className:`ss-box-topbar`,...m,...h,children:[(0,H.jsx)(`span`,{className:`ss-box-icon`,style:{background:j.color},children:j.icon}),(0,H.jsx)(`span`,{className:`ss-box-title`,children:ie}),(0,H.jsx)(`span`,{className:`ss-box-spacer`}),(C||e.content)&&(0,H.jsxs)(H.Fragment,{children:[C&&!b&&!S&&(0,H.jsx)(`button`,{type:`button`,className:`ss-box-action ss-box-targeted-add`,onClick:t=>{t.stopPropagation(),c(e.id)},title:`Add element inside...`,children:`+`}),(0,H.jsx)(`button`,{type:`button`,className:`ss-box-action ss-box-collapse-btn`,onClick:e=>{e.stopPropagation(),E(!T)},title:T?`Expand`:`Collapse`,children:T?`⤢`:`⤡`})]}),!b&&(0,H.jsxs)(`div`,{className:`ss-box-menu-container`,ref:te,onClick:e=>e.stopPropagation(),children:[(0,H.jsx)(`button`,{type:`button`,className:`ss-box-action ss-box-options-btn`,onClick:e=>{e.stopPropagation(),O(!D)},title:`Options`,children:`•••`}),D&&(0,H.jsxs)(`div`,{className:`ss-box-dropdown`,children:[(0,H.jsx)(`button`,{type:`button`,onClick:t=>{t.stopPropagation(),O(!1),i&&i(e.id)},children:`Edit Settings`}),(0,H.jsx)(`button`,{type:`button`,onClick:t=>{t.stopPropagation(),O(!1),a&&a(e.id)},children:`Duplicate`}),e.tag===`table`&&(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(`button`,{type:`button`,onClick:t=>{t.stopPropagation(),O(!1),s&&s(e.id,`thead`)},children:`+ Add Table Head (thead)`}),(0,H.jsx)(`button`,{type:`button`,onClick:t=>{t.stopPropagation(),O(!1),s&&s(e.id,`tbody`)},children:`+ Add Table Body (tbody)`}),(0,H.jsx)(`button`,{type:`button`,onClick:t=>{t.stopPropagation(),O(!1),s&&s(e.id,`tr`)},children:`+ Add Row (tr)`})]}),[`thead`,`tbody`].includes(e.tag)&&(0,H.jsx)(`button`,{type:`button`,onClick:t=>{t.stopPropagation(),O(!1),s&&s(e.id,`tr`)},children:`+ Add Row (tr)`}),e.tag===`tr`&&(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(`button`,{type:`button`,onClick:t=>{t.stopPropagation(),O(!1),s&&s(e.id,`td`)},children:`+ Add Cell (td)`}),(0,H.jsx)(`button`,{type:`button`,onClick:t=>{t.stopPropagation(),O(!1),s&&s(e.id,`th`)},children:`+ Add Cell (th)`})]}),e.tag===`form`&&(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(`button`,{type:`button`,onClick:t=>{t.stopPropagation(),O(!1),s&&s(e.id,`input`)},children:`+ Add Input`}),(0,H.jsx)(`button`,{type:`button`,onClick:t=>{t.stopPropagation(),O(!1),s&&s(e.id,`label`)},children:`+ Add Label`}),(0,H.jsx)(`button`,{type:`button`,onClick:t=>{t.stopPropagation(),O(!1),s&&s(e.id,`select`)},children:`+ Add Select`}),(0,H.jsx)(`button`,{type:`button`,onClick:t=>{t.stopPropagation(),O(!1),s&&s(e.id,`textarea`)},children:`+ Add Textarea`})]}),[`ul`,`ol`].includes(e.tag)&&(0,H.jsx)(`button`,{type:`button`,onClick:t=>{t.stopPropagation(),O(!1),s&&s(e.id,`li`)},children:`+ Add Item`}),e.tag===`select`&&(0,H.jsx)(`button`,{type:`button`,onClick:t=>{t.stopPropagation(),O(!1),s&&s(e.id,`option`)},children:`+ Add Option`}),(0,H.jsx)(`div`,{className:`ss-box-dropdown-divider`}),(0,H.jsx)(`button`,{type:`button`,className:`ss-box-dropdown-danger`,onClick:t=>{t.stopPropagation(),O(!1),o&&o(e.id)},children:`Delete`})]})]})]}),!T&&C&&(0,H.jsx)(`div`,{ref:w,className:`ss-box-body ${k?`ss-box-row-body`:``} ${re?`ss-box-drop-inside-active`:``}`,style:e.props?.isBgImage&&e.content&&!(typeof e.content==`string`&&/^\{\{\s*field_/.test(e.content.trim()))?{backgroundImage:`url(${e.content})`,backgroundSize:`cover`,backgroundPosition:`center`,minHeight:`100px`}:e.props?.isBgImage?{minHeight:`100px`,backgroundColor:`#f3f4f6`,border:`1px dashed #cbd5e1`}:{},children:(0,H.jsx)(wc,{parentNode:e,mode:t,selectedId:n,onSelect:r,onOpenProperties:i,onDuplicate:a,onDelete:o,onQuickAdd:s,onStartTargetedAdd:c,onSaveAsComponent:l,pendingParentId:u,availableComponents:d,depth:y+1,isInherited:b||S,isRow:k})}),(()=>{let t=(e=>typeof e==`string`&&/^\{\{\s*field_/i.test(e.trim()))(e.content)?``:e.content;return!T&&!C&&t&&(0,H.jsx)(`div`,{className:`ss-box-text-content`,children:e.tag===`img`?(0,H.jsx)(`div`,{className:`ss-box-image-preview`,children:(0,H.jsx)(`img`,{src:t,alt:`Preview`,style:{maxWidth:`100%`,maxHeight:`150px`,borderRadius:`4px`,display:`block`,margin:`0 auto`}})}):e.tag===`svg`?(0,H.jsx)(`div`,{className:`ss-box-image-preview`,style:{textAlign:`center`,padding:`8px`},children:t.trim().startsWith(`<`)?(0,H.jsx)(`div`,{style:{display:`inline-block`,maxWidth:`100%`,maxHeight:`150px`},dangerouslySetInnerHTML:{__html:t}}):(0,H.jsx)(`img`,{src:t,alt:`SVG Preview`,style:{maxWidth:`100%`,maxHeight:`150px`,display:`block`,margin:`0 auto`}})}):t})})()]})}function Dc({parentId:e,index:t,isActive:n}){let{setNodeRef:r,isOver:i}=kn({id:`gap::${e}::${t}`});return(0,H.jsx)(`div`,{ref:r,className:`ss-drop-gap ${i?`ss-drop-gap-active`:``} ${n?`ss-drop-gap-visible`:``}`})}function Oc({nodes:e,selectedId:t,onSelect:n,onOpenProperties:r,onDuplicate:i,onDelete:a,onQuickAdd:o,onStartTargetedAdd:s,onSaveAsComponent:c,pendingParentId:l,availableComponents:u}){let{isDraggingGlobal:d}=Sc(),{setNodeRef:f,isOver:p}=kn({id:`canvas-root`});return(0,H.jsxs)(`div`,{ref:f,className:`tree-render ${p?`root-over`:``} ${d?`is-dragging-mode`:``}`,children:[e.map((e,f)=>(0,H.jsxs)(`div`,{className:`ss-drop-slot`,children:[d&&(0,H.jsx)(Dc,{parentId:`canvas-root`,index:f,isActive:d}),(0,H.jsx)(bc,{node:e,selectedId:t,onSelect:n,onOpenProperties:r,onDuplicate:i,onDelete:a,onQuickAdd:o,onStartTargetedAdd:s,onSaveAsComponent:c,pendingParentId:l,availableComponents:u})]},e.id)),d&&(0,H.jsx)(Dc,{parentId:`canvas-root`,index:e.length,isActive:d}),d&&(0,H.jsx)(`div`,{className:`canvas-extract-hint`,children:`Drop here to move to root`})]})}var kc={Layout:`#f59e0b`,Media:`#10b981`,Typography:`#3b82f6`,Interactive:`#f97316`,Drupal:`#06b6d4`},Ac={Container:`□`,"Plain Div":`□`,Row:`⊞`,Column:`⊞`,Section:`📑`,Article:`📄`,Main:`🔲`,Aside:`◧`,Grid:`⊞`,Image:`🖼`,Video:`▶`,"Heading 1":`H1`,"Heading 2":`H2`,"Heading 3":`H3`,"Heading 4":`H4`,"Heading 5":`H5`,"Heading 6":`H6`,Paragraph:`¶`,"Span / Text":`T`,Button:`▢`,Link:`⟁`,Block:`☐`,Menu:`☰`};function jc({nodes:e}){return!e||!Array.isArray(e)?null:(0,H.jsx)(`ul`,{className:`ss-preview-list`,children:e.map((e,t)=>(0,H.jsxs)(`li`,{className:`ss-preview-item`,children:[(0,H.jsx)(`span`,{className:`ss-preview-tag`,children:e.tag}),e.label&&(0,H.jsxs)(`span`,{className:`ss-preview-label`,children:[`(`,e.label,`)`]}),e.children&&e.children.length>0&&(0,H.jsx)(jc,{nodes:e.children})]},t))})}function Mc({comp:e,addComponentInstance:t}){let[n,r]=(0,_.useState)(!1);return(0,H.jsxs)(`div`,{className:`ss-component-item`,children:[(0,H.jsxs)(`div`,{className:`ss-element-row ${n?`ss-element-row-expanded`:``}`,onClick:()=>t(e.id),title:`Add ${e.label}`,children:[(0,H.jsx)(`span`,{className:`ss-component-toggle`,onClick:e=>{e.stopPropagation(),r(!n)},children:n?`▼`:`▶`}),(0,H.jsx)(`span`,{className:`ss-element-icon`,style:{background:`#8b5cf6`},children:`🧩`}),(0,H.jsx)(`span`,{className:`ss-element-label`,children:e.label}),(0,H.jsx)(`button`,{type:`button`,className:`ss-element-add`,title:`Add ${e.label}`,children:(0,H.jsxs)(`svg`,{width:`18`,height:`18`,viewBox:`0 0 20 20`,fill:`none`,children:[(0,H.jsx)(`circle`,{cx:`10`,cy:`10`,r:`9`,stroke:`currentColor`,strokeWidth:`1.5`}),(0,H.jsx)(`path`,{d:`M10 6v8M6 10h8`,stroke:`currentColor`,strokeWidth:`1.5`,strokeLinecap:`round`})]})})]}),n&&e.layout_tree&&(0,H.jsx)(`div`,{className:`ss-component-preview`,children:(0,H.jsx)(jc,{nodes:e.layout_tree})})]})}function Nc({el:e,catColor:t,onClick:n}){let{attributes:r,listeners:i,setNodeRef:a,transform:o,isDragging:s}=Tn({id:`sidebar-el-${e.label}`,data:{type:`sidebar-element`,element:e}});return(0,H.jsxs)(`div`,{ref:a,style:o?{transform:`translate3d(${o.x}px, ${o.y}px, 0)`,zIndex:1e3,opacity:s?.5:1}:void 0,className:`ss-element-row ${s?`is-dragging`:``}`,onClick:()=>n(e),title:`Add ${e.label}`,...i,...r,children:[(0,H.jsx)(`span`,{className:`ss-element-icon`,style:{background:t},children:e.icon||Ac[e.label]||`□`}),(0,H.jsx)(`span`,{className:`ss-element-label`,children:e.label}),(0,H.jsx)(`button`,{type:`button`,className:`ss-element-add`,title:`Add ${e.label}`,children:(0,H.jsxs)(`svg`,{width:`18`,height:`18`,viewBox:`0 0 20 20`,fill:`none`,children:[(0,H.jsx)(`circle`,{cx:`10`,cy:`10`,r:`9`,stroke:`currentColor`,strokeWidth:`1.5`}),(0,H.jsx)(`path`,{d:`M10 6v8M6 10h8`,stroke:`currentColor`,strokeWidth:`1.5`,strokeLinecap:`round`})]})})]})}function Pc({mode:e,availableComponents:t=[],customStyles:n=[],selectedNodeId:r,currentStyle:i,selectedNode:a,addElement:o,addComponentInstance:s,onSelectStyle:c,onDeselect:l,onClose:u}){let[d,f]=(0,_.useState)(`elements`),[p,m]=(0,_.useState)(``),[h,g]=(0,_.useState)([`Layout`,`Media`,`Typography`,`Tables`,`Lists`,`Forms`]),v=e=>{g(t=>t.includes(e)?t.filter(t=>t!==e):[...t,e])},y=ic.map(e=>({...e,elements:e.elements.filter(e=>!p||e.label.toLowerCase().includes(p.toLowerCase()))})).filter(e=>e.elements.length>0);return(0,H.jsxs)(`aside`,{className:`ui-builder-sidebar`,children:[(0,H.jsxs)(`div`,{className:`sidebar-header`,children:[(0,H.jsx)(`h3`,{className:`sidebar-header-title`,children:`Elements`}),(0,H.jsx)(`button`,{type:`button`,className:`sidebar-close-btn`,onClick:u,title:`Close`,children:`✕`})]}),(0,H.jsx)(`div`,{className:`sidebar-tabs`,children:[`elements`,`library`,`styles`].map(e=>(0,H.jsx)(`button`,{type:`button`,className:`tab-btn ${d===e?`active`:``}`,onClick:()=>f(e),children:e.charAt(0).toUpperCase()+e.slice(1)},e))}),d===`elements`&&(0,H.jsxs)(`div`,{className:`sidebar-search`,children:[(0,H.jsx)(`span`,{className:`sidebar-search-icon`,children:(0,H.jsxs)(`svg`,{width:`12`,height:`12`,viewBox:`0 0 16 16`,fill:`none`,children:[(0,H.jsx)(`circle`,{cx:`6.5`,cy:`6.5`,r:`5.5`,stroke:`currentColor`,strokeWidth:`1.5`}),(0,H.jsx)(`path`,{d:`M11 11l4 4`,stroke:`currentColor`,strokeWidth:`1.5`,strokeLinecap:`round`})]})}),(0,H.jsx)(`input`,{type:`text`,className:`sidebar-search-input`,placeholder:`Search for Elements`,value:p,onChange:e=>m(e.target.value)}),p&&(0,H.jsx)(`button`,{type:`button`,className:`sidebar-search-clear`,onClick:()=>m(``),children:`✕`})]}),(0,H.jsxs)(`div`,{className:`sidebar-content`,children:[d===`elements`&&(0,H.jsxs)(`div`,{className:`animate-fade`,children:[y.length===0&&(0,H.jsxs)(`div`,{className:`no-items-hint`,children:[`No elements match "`,p,`"`]}),y.map(e=>{let t=kc[e.name]||`#64748b`,n=h.includes(e.name)||p;return(0,H.jsxs)(`div`,{className:`ss-element-category ${n?`expanded`:`collapsed`}`,children:[(0,H.jsxs)(`div`,{className:`ss-category-title`,onClick:()=>v(e.name),style:{cursor:`pointer`,display:`flex`,justifyContent:`space-between`,alignItems:`center`},children:[(0,H.jsxs)(`span`,{children:[e.name,` elements`]}),(0,H.jsx)(`span`,{style:{fontSize:`10px`,opacity:.5},children:n?`▼`:`▶`})]}),n&&(0,H.jsx)(`div`,{className:`ss-category-list`,children:e.elements.map(e=>(0,H.jsx)(Nc,{el:e,catColor:t,onClick:o},e.label))})]},e.name)})]}),d===`library`&&(0,H.jsx)(`div`,{className:`animate-fade`,children:(0,H.jsxs)(`div`,{className:`ss-element-category`,children:[(0,H.jsx)(`div`,{className:`ss-category-title`,children:`Reusable Components`}),(0,H.jsxs)(`div`,{className:`ss-category-list`,children:[t.map(e=>(0,H.jsx)(Mc,{comp:e,addComponentInstance:s},e.id)),t.length===0&&(0,H.jsx)(`div`,{className:`no-items-hint`,children:`No components saved yet.`})]})]})}),d===`styles`&&(0,H.jsx)(`div`,{className:`animate-fade`,children:(0,H.jsxs)(`div`,{className:`ss-element-category`,children:[(0,H.jsx)(`div`,{className:`ss-category-title`,children:`Global Styles`}),(0,H.jsxs)(`div`,{className:`ss-category-list`,children:[n.map(e=>(0,H.jsxs)(`div`,{className:`ss-element-row ${i?.id===e.id?`ss-element-row-active`:``}`,onClick:()=>c(e.id),children:[(0,H.jsx)(`span`,{className:`ss-element-icon`,style:{background:`#10b981`},children:`🎨`}),(0,H.jsxs)(`span`,{className:`ss-element-label`,children:[`.`,e.id]})]},e.id)),(0,H.jsxs)(`div`,{className:`ss-element-row ss-element-row-add-new`,onClick:()=>{c(`style-`+Math.random().toString(36).substr(2,5))},children:[(0,H.jsx)(`span`,{className:`ss-element-icon`,style:{background:`#475569`},children:`+`}),(0,H.jsx)(`span`,{className:`ss-element-label`,children:`Create New Style`})]})]})]})})]}),(r||i)&&(0,H.jsxs)(`div`,{className:`sidebar-context-hint`,children:[r?(0,H.jsxs)(`span`,{children:[`✅ `,(0,H.jsx)(`strong`,{children:a?.label||a?.tag})]}):(0,H.jsxs)(`span`,{children:[`🎨 `,(0,H.jsxs)(`strong`,{children:[`Style: .`,i?.id]})]}),(0,H.jsx)(`button`,{type:`button`,className:`deselect-link`,onClick:l,children:`Deselect`})]})]})}function Fc({mode:e,value:t,onUpdate:n}){return(0,H.jsxs)(`div`,{className:`field-editor-wrapper`,children:[(0,H.jsxs)(`div`,{className:`field-mode-toggle`,children:[(0,H.jsx)(`button`,{type:`button`,className:`mode-btn ${e===`static`?`active`:``}`,onClick:()=>n(t,`static`),children:`Static`}),(0,H.jsx)(`button`,{type:`button`,className:`mode-btn ${e===`mapping`?`active`:``}`,onClick:()=>n(t,`mapping`),children:`Mapping`})]}),(0,H.jsx)(`div`,{className:`field-input-container`,children:e===`mapping`?(0,H.jsxs)(`div`,{className:`input-with-prefix`,children:[(0,H.jsx)(`span`,{className:`prefix`,children:`[`}),(0,H.jsx)(`input`,{type:`text`,className:`mapping-source-input`,value:t||``,placeholder:`e.g. node:title`,onChange:e=>n(e.target.value,`mapping`),onKeyDown:e=>{e.key===`Enter`&&(e.preventDefault(),e.stopPropagation(),e.nativeEvent&&e.nativeEvent.stopImmediatePropagation&&e.nativeEvent.stopImmediatePropagation())}}),(0,H.jsx)(`span`,{className:`prefix`,children:`]`})]}):(0,H.jsx)(`textarea`,{className:`form-control`,value:t||``,placeholder:`Enter text content...`,onChange:e=>n(e.target.value,`static`)})})]})}function Ic({isOpen:e,onClose:t,onSelect:n,accept:r=`image/*,.svg`}){let[i,a]=(0,_.useState)([]),[o,s]=(0,_.useState)(!1),[c,l]=(0,_.useState)(!1),u=(0,_.useRef)(null);(0,_.useEffect)(()=>{e&&d()},[e]);let d=async()=>{s(!0);try{let e=await fetch(`/ui-builder/images`);e.ok&&a(await e.json())}catch(e){console.error(`Error fetching images:`,e)}finally{s(!1)}};return e?(0,H.jsx)(`div`,{className:`media-library-modal-overlay`,onClick:t,children:(0,H.jsxs)(`div`,{className:`media-library-modal-container`,onClick:e=>e.stopPropagation(),children:[(0,H.jsxs)(`div`,{className:`media-library-modal-header`,children:[(0,H.jsx)(`h3`,{children:`Media Library`}),(0,H.jsx)(`button`,{type:`button`,className:`close-modal-btn`,onClick:t,children:`×`})]}),(0,H.jsxs)(`div`,{className:`media-library-modal-body`,children:[(0,H.jsxs)(`div`,{className:`media-library-actions`,children:[(0,H.jsx)(`input`,{type:`file`,ref:u,onChange:async e=>{let t=e.target.files[0];if(t){l(!0);let e=new FormData;e.append(`files[image]`,t);try{let t=window.drupalSettings?.ui_builder?.csrf_token,n={};t&&(n[`X-CSRF-Token`]=t);let r=await fetch(`/ui-builder/upload`,{method:`POST`,body:e,headers:n});if(r.ok)d();else{let e=await r.json().catch(()=>({}));alert(`Upload failed: `+(e.error||`Server error `+r.status))}}catch(e){console.error(`Error uploading file:`,e),alert(`Error connecting to upload server.`)}finally{l(!1)}}},style:{display:`none`},accept:r}),(0,H.jsx)(`button`,{type:`button`,className:`upload-new-btn`,onClick:()=>u.current?.click(),disabled:c,children:c?`Uploading...`:`Upload New Media`}),(0,H.jsx)(`span`,{className:`media-library-help-text`,children:r===`.svg,image/svg+xml`?`Allowed format: SVG`:`Allowed formats: PNG, JPG, GIF, WEBP, SVG`})]}),o?(0,H.jsx)(`div`,{className:`loading-state`,children:`Loading images...`}):(0,H.jsxs)(`div`,{className:`images-grid`,children:[i.filter(e=>r===`.svg,image/svg+xml`?e.url?.toLowerCase().endsWith(`.svg`)||e.mime===`image/svg+xml`:!0).map(e=>(0,H.jsxs)(`div`,{className:`image-item`,onClick:()=>n(e.url),children:[(0,H.jsx)(`div`,{className:`image-wrapper`,children:(0,H.jsx)(`img`,{src:e.url,alt:e.name,title:e.name})}),(0,H.jsx)(`div`,{className:`image-name`,children:e.name})]},e.mid)),i.filter(e=>r===`.svg,image/svg+xml`?e.url?.toLowerCase().endsWith(`.svg`)||e.mime===`image/svg+xml`:!0).length===0&&(0,H.jsx)(`div`,{className:`no-images`,children:`No media found.`})]})]})]})}):null}function Lc({mode:e,value:t,onUpdate:n,accept:r=`image/*,.svg`,label:i=`Image`}){let[a,o]=(0,_.useState)(!1),s=Array.isArray(t)?t:t?[t]:[];return(0,H.jsxs)(`div`,{className:`field-editor-wrapper image-editor`,children:[(0,H.jsxs)(`div`,{className:`field-mode-toggle`,children:[(0,H.jsx)(`button`,{type:`button`,className:`mode-btn ${e===`static`?`active`:``}`,onClick:()=>n(t,`static`),children:`Static`}),(0,H.jsx)(`button`,{type:`button`,className:`mode-btn ${e===`mapping`?`active`:``}`,onClick:()=>n(t,`mapping`),children:`Mapping`})]}),(0,H.jsx)(`div`,{className:`field-input-container`,children:e===`mapping`?(0,H.jsxs)(`div`,{className:`input-with-prefix`,children:[(0,H.jsx)(`span`,{className:`prefix`,children:`[`}),(0,H.jsx)(`input`,{type:`text`,className:`mapping-source-input`,value:typeof t==`string`?t:``,placeholder:`field_image_mapping`,onChange:e=>n(e.target.value,`mapping`),onKeyDown:e=>{e.key===`Enter`&&(e.preventDefault(),e.stopPropagation(),e.nativeEvent&&e.nativeEvent.stopImmediatePropagation&&e.nativeEvent.stopImmediatePropagation())}}),(0,H.jsx)(`span`,{className:`prefix`,children:`]`})]}):(0,H.jsxs)(`div`,{className:`image-static-controls`,children:[(0,H.jsx)(`div`,{className:`image-preview-grid`,children:s.length>0?s.map((e,t)=>(0,H.jsxs)(`div`,{className:`image-preview-item`,children:[(0,H.jsx)(`img`,{src:e,alt:`Preview`}),(0,H.jsx)(`button`,{type:`button`,className:`remove-img`,onClick:()=>{let e=s.filter((e,n)=>n!==t);n(e.length===0?``:e.length===1?e[0]:e,`static`)},children:`× `})]},t)):(0,H.jsx)(`div`,{className:`image-placeholder`,children:`No image selected`})}),(0,H.jsx)(`button`,{type:`button`,className:`upload-btn`,onClick:()=>o(!0),children:s.length>0?`Change / Add ${i}`:`Select / Upload ${i}`})]})}),(0,H.jsx)(Ic,{isOpen:a,onClose:()=>o(!1),accept:r,onSelect:e=>{n(e,`static`),o(!1)}})]})}var Rc=`font-size.font-weight.color.line-height.letter-spacing.text-align.text-transform.font-family.padding.padding-top.padding-right.padding-bottom.padding-left.margin.margin-top.margin-bottom.margin-right.margin-left.display.width.height.max-width.position.z-index.flex-direction.justify-content.align-items.gap.background-color.background.border.border-radius.box-shadow.opacity.cursor.transition`.split(`.`);function zc({title:e,icon:t,children:n}){let[r,i]=(0,_.useState)(!1);return(0,H.jsxs)(`div`,{className:`prop-group ${r?`open`:``}`,children:[(0,H.jsxs)(`div`,{className:`group-title`,onClick:()=>i(!r),children:[(0,H.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`12px`},children:[(0,H.jsx)(`span`,{style:{opacity:.6,fontSize:`16px`},children:t}),e]}),(0,H.jsx)(`span`,{children:r?`▼`:`▶`})]}),r&&(0,H.jsx)(`div`,{className:`group-fields`,children:n})]})}function Bc({value:e,defaultValue:t,onChange:n,placeholder:r,style:i,onBlur:a}){let[o,s]=(0,_.useState)(e===void 0?t||``:e),[c,l]=(0,_.useState)(!1),[u,d]=(0,_.useState)([]),[f,p]=(0,_.useState)(0);return(0,_.useEffect)(()=>{e!==void 0&&s(e)},[e]),(0,H.jsxs)(`div`,{style:{position:`relative`,flex:i?.flex||`unset`,minWidth:0},children:[(0,H.jsx)(`input`,{type:`text`,value:o,onChange:e=>{let t=e.target.value;if(s(t),n&&n(e),t.trim()){let e=Rc.filter(e=>e.startsWith(t.toLowerCase()));d(e),l(e.length>0),p(0)}else l(!1)},onKeyDown:e=>{c&&(e.key===`ArrowDown`?(e.preventDefault(),p(e=>Math.min(e+1,u.length-1))):e.key===`ArrowUp`?(e.preventDefault(),p(e=>Math.max(e-1,0))):e.key===`Enter`?(e.preventDefault(),u[f]&&(s(u[f]),n&&n({target:{value:u[f]}}),l(!1))):e.key===`Escape`&&l(!1))},onBlur:e=>{setTimeout(()=>l(!1),200),a&&a(e)},placeholder:r,style:{...i,width:`100%`}}),c&&(0,H.jsx)(`div`,{style:{position:`absolute`,top:`100%`,left:0,right:0,background:`#fff`,border:`1px solid var(--sb-border)`,borderRadius:`4px`,boxShadow:`0 4px 6px rgba(0,0,0,0.1)`,zIndex:1e3,maxHeight:`150px`,overflowY:`auto`},children:u.map((e,t)=>(0,H.jsx)(`div`,{onClick:()=>{s(e),n&&n({target:{value:e}}),l(!1)},style:{padding:`6px 8px`,cursor:`pointer`,fontSize:`12px`,background:t===f?`#e6f7ff`:`#fff`,color:`var(--text-main)`},children:e},e))})]})}function Vc({customProperties:e,onChange:t,newProp:n,setNewProp:r,newValue:i,setNewValue:a,activeDevice:o=`desktop`,setActiveDevice:s}){let c=window.drupalSettings?.ui_builder?.breakpoints||{tablet:`1024px`,mobile:`767px`},l=Object.keys(c),u=()=>{if(n.trim()&&i.trim()){let e=n.trim();o!==`desktop`&&(e=`${o}:${e}`),t(e,i.trim()),r(``),a(``)}},d=Object.keys(e||{}).filter(e=>o===`desktop`?!l.some(t=>e.startsWith(`${t}:`)):e.startsWith(`${o}:`));return(0,H.jsxs)(`div`,{className:`custom-css-editor`,children:[(0,H.jsxs)(`div`,{style:{display:`flex`,gap:`4px`,marginBottom:`12px`,borderBottom:`1px solid var(--sb-border)`,paddingBottom:`8px`},children:[(0,H.jsx)(`button`,{type:`button`,onClick:()=>s(`desktop`),style:{padding:`4px 8px`,fontSize:`11px`,borderRadius:`4px`,background:o===`desktop`?`#e6f7ff`:`none`,border:`none`,cursor:`pointer`,color:o===`desktop`?`#0050b3`:`var(--text-muted)`},children:`🖥️ Desktop`}),l.map(e=>(0,H.jsx)(`button`,{type:`button`,onClick:()=>s(e),style:{padding:`4px 8px`,fontSize:`11px`,borderRadius:`4px`,background:o===e?`#e6f7ff`:`none`,border:`none`,cursor:`pointer`,color:o===e?`#0050b3`:`var(--text-muted)`},children:e.charAt(0).toUpperCase()+e.slice(1)},e))]}),d.length>0&&(0,H.jsx)(`div`,{className:`custom-css-list`,style:{display:`flex`,flexDirection:`column`,gap:`8px`,marginBottom:`16px`},children:d.map(n=>{let r=n.includes(`:`)?n.split(`:`).pop():n;return(0,H.jsxs)(`div`,{style:{display:`flex`,gap:`8px`,alignItems:`center`},children:[(0,H.jsx)(Bc,{defaultValue:r,onBlur:i=>{let a=i.target.value.trim();a&&a!==r&&t(o===`desktop`?a:`${o}:${a}`,e[n],n)},style:{flex:1,padding:`6px 8px`,border:`1px solid var(--sb-border)`,borderRadius:`4px`,fontSize:`12px`}}),(0,H.jsx)(`input`,{type:`text`,value:e[n],onChange:e=>t(n,e.target.value),style:{flex:2,padding:`6px 8px`,border:`1px solid var(--sb-border)`,borderRadius:`4px`,fontSize:`12px`}}),(0,H.jsx)(`button`,{type:`button`,onClick:()=>t(n,``),style:{background:`none`,border:`none`,color:`#ff4d4f`,cursor:`pointer`,padding:`4px`},title:`Remove property`,children:`✕`})]},n)})}),(0,H.jsxs)(`div`,{style:{display:`flex`,gap:`8px`,alignItems:`center`,background:`#fdfdfd`,padding:`12px`,borderRadius:`6px`,border:`1px dashed var(--sb-border)`},children:[(0,H.jsx)(Bc,{placeholder:`Property for ${o}`,value:n,onChange:e=>r(e.target.value),style:{flex:1,padding:`6px 8px`,border:`1px solid var(--sb-border)`,borderRadius:`4px`,fontSize:`12px`}}),(0,H.jsx)(`input`,{type:`text`,placeholder:`Value`,value:i,onChange:e=>a(e.target.value),onKeyDown:e=>e.key===`Enter`&&u(),style:{flex:1,padding:`6px 8px`,border:`1px solid var(--sb-border)`,borderRadius:`4px`,fontSize:`12px`}}),(0,H.jsx)(`button`,{type:`button`,onClick:u,style:{padding:`6px 12px`,background:`var(--primary)`,color:`white`,border:`none`,borderRadius:`4px`,cursor:`pointer`,fontSize:`12px`,fontWeight:`500`},children:`Add`})]})]})}function Hc({selectedNode:e,updateProperty:t,updateCustomProperty:n,pendingProp:r,setPendingProp:i,pendingValue:a,setPendingValue:o,activeDevice:s,setActiveDevice:c}){return(0,H.jsx)(`div`,{className:`property-groups`,children:(0,H.jsx)(zc,{title:`Custom CSS`,icon:`{ }`,children:(0,H.jsx)(Vc,{customProperties:e.custom_properties,onChange:n,newProp:r,setNewProp:i,newValue:a,setNewValue:o,activeDevice:s,setActiveDevice:c})})})}function Uc({data:e,selectedNodePath:t,setSelectedNodePath:n,editingNodePath:r,setEditingNodePath:i,editValue:a,setEditValue:o,isAddingNew:s,setIsAddingNew:c,collapsedPaths:l,setCollapsedPaths:u,draggedNodePath:d,setDraggedNodePath:f,dropTargetInfo:p,setDropTargetInfo:m,onNodeAction:h,rootLabel:g}){let v=(0,_.useRef)(null);(0,_.useEffect)(()=>{r&&v.current&&(v.current.focus(),v.current.select())},[r]);let y=(e,t)=>{e.stopPropagation(),u(e=>{let n=new Set(e);return n.has(t)?n.delete(t):n.add(t),n})},b=(e,i=[`root`],c=0)=>{let u=JSON.stringify(i)===JSON.stringify(t),f=JSON.stringify(i)===JSON.stringify(r),m=d&&JSON.stringify(i)===JSON.stringify(d),_=i.length===1,x=p&&JSON.stringify(p.path)===JSON.stringify(i)&&p.position===`before`,S=p&&JSON.stringify(p.path)===JSON.stringify(i)&&p.position===`after`,C=p&&JSON.stringify(p.path)===JSON.stringify(i)&&p.position===`inside`,w=e.children&&e.children.length>0||s&&JSON.stringify(i)===JSON.stringify(r?.slice(0,-1)),ee=i.join(`-`),T=l.has(ee);return(0,H.jsxs)(`div`,{className:`ss-sel-wrapper ${_?`ss-sel-root`:``}`,children:[!_&&(0,H.jsx)(`div`,{className:`ss-sel-drop-zone ${x?`active`:``}`,onDragOver:e=>h(`dragOver`,e,i,`before`),onDrop:e=>h(`drop`,e,i,`before`)}),(0,H.jsxs)(`div`,{className:`ss-sel-row`,children:[!_&&(w?(0,H.jsx)(`button`,{type:`button`,className:`ss-sel-collapse-toggle`,onClick:e=>y(e,ee),children:T?`+`:`−`}):(0,H.jsx)(`div`,{className:`ss-sel-collapse-spacer`})),(0,H.jsxs)(`div`,{className:`ss-sel-card ${u?`ss-sel-selected`:``} ${m?`ss-sel-dragging`:``} ${C?`ss-sel-drop-inside`:``} ${_?`ss-sel-card-root`:``}`,onClick:()=>n(i),draggable:!_&&!f,onDragStart:e=>h(`dragStart`,e,i),onDragEnd:()=>h(`dragEnd`),onDragOver:e=>h(`dragOver`,e,i,`inside`),onDrop:e=>h(`drop`,e,i,`inside`),children:[!_&&(0,H.jsx)(`span`,{className:`ss-sel-drag-handle`,children:`✥`}),f?(0,H.jsx)(`input`,{ref:v,className:`ss-sel-edit-input`,value:a,onChange:e=>o(e.target.value),onBlur:()=>h(`finishEdit`),onKeyDown:e=>e.key===`Enter`&&h(`finishEdit`),onClick:e=>e.stopPropagation()}):(0,H.jsxs)(`span`,{className:`ss-sel-name`,onDoubleClick:e=>h(`rename`,e,i),children:[_?g||`Default`:e.selector||`&`,!_&&c>1&&(0,H.jsx)(`span`,{className:`ss-sel-annotation`,children:` (child)`})]}),(0,H.jsx)(`button`,{type:`button`,className:`ss-sel-add`,onClick:e=>h(`add`,e,i),children:`⊕`}),!_&&(0,H.jsx)(`button`,{type:`button`,className:`ss-sel-delete`,onClick:e=>h(`delete`,e,i),title:`Delete selector`,children:`×`})]})]}),!_&&(0,H.jsx)(`div`,{className:`ss-sel-drop-zone ${S?`active`:``}`,onDragOver:e=>h(`dragOver`,e,i,`after`),onDrop:e=>h(`drop`,e,i,`after`)}),w&&!T&&(0,H.jsxs)(`div`,{className:`ss-sel-children`,children:[e.children&&e.children.map((t,n)=>{let a=n===e.children.length-1&&!(s&&JSON.stringify(i)===JSON.stringify(r?.slice(0,-1))),o=t.children&&t.children.length>0;return(0,H.jsx)(`div`,{className:`ss-sel-child-item ${a?`ss-sel-child-last`:``} ${o?``:`ss-sel-child-leaf`}`,children:b(t,[...i,n],c+1)},n)}),s&&JSON.stringify(i)===JSON.stringify(r?.slice(0,-1))&&(0,H.jsx)(`div`,{className:`ss-sel-child-item ss-sel-child-last ss-sel-child-leaf`,children:(0,H.jsxs)(`div`,{className:`ss-sel-row`,children:[(0,H.jsx)(`div`,{className:`ss-sel-collapse-spacer`}),(0,H.jsxs)(`div`,{className:`ss-sel-card ss-sel-selected`,children:[(0,H.jsx)(`span`,{className:`ss-sel-drag-handle`,style:{visibility:`hidden`},children:`✥`}),(0,H.jsx)(`input`,{ref:v,className:`ss-sel-edit-input`,value:a,onChange:e=>o(e.target.value),onBlur:()=>h(`finishEdit`),onKeyDown:e=>e.key===`Enter`&&h(`finishEdit`)})]})]})})]})]},ee)};return(0,H.jsx)(`div`,{className:`tree-content`,children:b(e)})}function Wc({title:e,children:t,defaultOpen:n=!1}){let[r,i]=(0,_.useState)(n);return(0,H.jsxs)(`div`,{className:`prop-group ${r?`open`:``}`,children:[(0,H.jsxs)(`div`,{className:`prop-group-header`,onClick:()=>i(!r),style:{padding:`16px 20px`,background:r?`#fdfdfd`:`#fff`,cursor:`pointer`,display:`flex`,justifyContent:`space-between`,alignItems:`center`,fontWeight:`600`,fontSize:`14px`,color:`var(--sb-text-main)`,userSelect:`none`,borderBottom:r?`1px solid var(--sb-border)`:`none`},children:[(0,H.jsx)(`span`,{className:`prop-group-title`,children:e}),(0,H.jsx)(`div`,{className:`prop-group-icon`,style:{transform:r?`rotate(180deg)`:`none`,transition:`transform 0.2s ease`,color:`var(--sb-text-muted)`},children:(0,H.jsx)(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`,strokeLinejoin:`round`,children:(0,H.jsx)(`polyline`,{points:`6 9 12 15 18 9`})})})]}),r&&(0,H.jsx)(`div`,{className:`prop-group-body`,style:{padding:`20px`,background:`#fdfdfd`},children:t})]})}function Gc({mode:e,selectedNode:t,selectedNodeId:n,selectedStyle:r,selectedComponent:i,updateNodeProperty:a,resetToDefaultProps:o,removeNode:s,updateNodeField:c,updateInstanceValue:l,updateInstanceStyles:u,onSaveStyle:d,onEditInstanceStyle:f,onDeselect:p,customStyles:m=[]}){let[h,g]=(0,_.useState)(null),[v,y]=(0,_.useState)([`root`]),[b,x]=(0,_.useState)(null),[S,C]=(0,_.useState)(``),[w,ee]=(0,_.useState)(!1),[T,E]=(0,_.useState)(new Set),[D,O]=(0,_.useState)(null),[te,ne]=(0,_.useState)(null),[k,A]=(0,_.useState)(`desktop`),[re,ie]=(0,_.useState)(``),[j,M]=(0,_.useState)(``),[ae,oe]=(0,_.useState)(``),[se,ce]=(0,_.useState)(``);(0,_.useEffect)(()=>{t&&t.instanceStyles?g(JSON.parse(JSON.stringify(t.instanceStyles))):g({selector:`&`,properties:{},custom_properties:{},children:[]}),y([`root`])},[n]),((e,t)=>{if(!e)return null;if(t.length===1&&t[0]===`root`)return e;let n=e;for(let e=1;e<t.length;e++){if(!n.children||!n.children[t[e]])return n;n=n.children[t[e]]}return n})(h,v);let le=e=>{let n=(t.props?.class||``).split(/\s+/).filter(Boolean).find(t=>t.startsWith(e));return n?n.replace(e,``):``},N=(e,n=``)=>{let r=(t.props?.class||``).split(/\s+/).filter(Boolean),i=`uib-col-`;n===`tablet:`&&(i=`uib-col-md-`),n===`mobile:`&&(i=`uib-col-sm-`),r=r.filter(e=>!e.startsWith(i)),e&&r.push(`${i}${e}`),c(t.id,{props:{...t.props,class:r.join(` `)}})};if((0,_.useEffect)(()=>{r&&(oe(r.css_content||``),ce(r.label||``))},[r]),(0,_.useEffect)(()=>{r&&(oe(r.css_content||``),ce(r.label||``))},[r]),!t&&!r)return null;if(r)return(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(`div`,{className:`properties-backdrop`,onClick:p}),(0,H.jsxs)(`aside`,{className:`ui-builder-properties`,children:[(0,H.jsxs)(`div`,{className:`properties-header`,children:[(0,H.jsx)(`h3`,{children:`Style Editor`}),(0,H.jsx)(`button`,{type:`button`,className:`properties-close-btn`,onClick:p,title:`Close`,children:`✕`})]}),(0,H.jsxs)(`div`,{className:`properties-content animate-fade`,children:[(0,H.jsxs)(`div`,{className:`form-group`,children:[(0,H.jsx)(`label`,{children:`Style Label`}),(0,H.jsx)(`input`,{type:`text`,className:`form-control`,value:se,onChange:e=>ce(e.target.value),placeholder:`e.g. Hero Title`})]}),(0,H.jsxs)(`div`,{className:`form-group`,children:[(0,H.jsx)(`label`,{children:`CSS Class`}),(0,H.jsx)(`input`,{type:`text`,className:`form-control`,value:`.${r.id}`,disabled:!0,style:{opacity:.6}})]}),(0,H.jsxs)(`div`,{className:`form-group`,children:[(0,H.jsx)(`label`,{children:`CSS Rules`}),(0,H.jsx)(`textarea`,{className:`form-control css-editor`,value:ae,onChange:e=>oe(e.target.value),placeholder:`.${r.id} {\n  color: #2563eb;\n  font-size: 24px;\n}`,spellCheck:`false`})]}),(0,H.jsx)(`button`,{type:`button`,className:`btn-primary`,style:{width:`100%`,marginTop:`12px`},onClick:()=>d({...r,label:se,css_content:ae}),children:`Save Style`})]})]})]});let P=!t.component_id&&!!t.tag,ue=(t.props?.class||``).split(/\s+/).filter(Boolean),de=ue.includes(`column`)||t.label===`Column`;t.label;let fe=P&&[`div`,`section`,`article`,`main`,`aside`,`nav`].includes(t.tag)&&!t.props?.isBgImage;return(0,H.jsxs)(`div`,{onKeyDown:e=>{e.key===`Enter`&&e.target.tagName.toLowerCase()===`input`&&(e.preventDefault(),e.stopPropagation(),e.nativeEvent&&e.nativeEvent.stopImmediatePropagation&&e.nativeEvent.stopImmediatePropagation())},children:[(0,H.jsx)(`div`,{className:`properties-backdrop`,onClick:p}),(0,H.jsxs)(`aside`,{className:`ui-builder-properties`,onClick:e=>e.stopPropagation(),children:[(0,H.jsxs)(`div`,{className:`properties-header`,children:[(0,H.jsx)(`h3`,{children:t.label||t.tag}),(0,H.jsx)(`button`,{type:`button`,className:`properties-close-btn`,onClick:p,title:`Close`,children:`✕`})]}),(0,H.jsx)(`div`,{className:`properties-content`,children:(0,H.jsxs)(`div`,{className:`animate-fade property-groups`,children:[t&&(0,H.jsx)(Wc,{title:`INSTANCE STYLING (SITE STUDIO STYLE)`,defaultOpen:!0,children:(0,H.jsxs)(`div`,{style:{marginTop:`16px`,padding:`4px`},className:`instance-style-editor animate-fade`,children:[(0,H.jsxs)(`p`,{className:`help-text`,style:{marginBottom:`16px`,fontSize:`12px`,color:`#64748b`,lineHeight:`1.5`},children:[`Apply scoped styles, selectors, pseudo-elements, and responsive queries directly to this `,t.label||t.tag,`.`]}),(0,H.jsx)(`button`,{type:`button`,className:`save-btn`,style:{width:`100%`,display:`flex`,alignItems:`center`,justifyContent:`center`,gap:`8px`,padding:`12px`,fontSize:`13px`,fontWeight:`bold`,background:`var(--sb-primary, #2563eb)`,color:`#fff`,border:`none`,borderRadius:`6px`,cursor:`pointer`,boxShadow:`0 2px 4px rgba(37, 99, 235, 0.2)`,transition:`all 0.2s ease-in-out`},onClick:()=>{f&&f({id:t.id,label:t.label||t.tag,data:t.instanceStyles||{selector:`&`,properties:{},custom_properties:{},children:[]},isInstance:!0})},children:`🎨 Edit CSS in Style Builder`})]})}),(0,H.jsxs)(Wc,{title:`General Settings`,defaultOpen:!0,children:[(0,H.jsxs)(`div`,{className:`form-group`,style:{marginTop:`16px`},children:[(0,H.jsx)(`label`,{children:`Label`}),(0,H.jsx)(`input`,{type:`text`,className:`form-control`,value:t.label||``,onChange:e=>c(t.id,{label:e.target.value}),placeholder:`Internal label...`})]}),de&&(0,H.jsxs)(`div`,{style:{marginTop:`16px`,borderTop:`1px solid #333`,paddingTop:`16px`},children:[(0,H.jsx)(`label`,{style:{marginBottom:`8px`,display:`block`},children:`Grid Columns`}),(0,H.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`1fr 1fr 1fr`,gap:`8px`},children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`label`,{style:{fontSize:`12px`,color:`#aaa`},children:`Desktop`}),(0,H.jsx)(`select`,{className:`form-control`,value:le(`uib-col-`)||`12`,onChange:e=>N(e.target.value,``),children:[...Array(12)].map((e,t)=>(0,H.jsx)(`option`,{value:t+1,children:t+1},t+1))})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`label`,{style:{fontSize:`12px`,color:`#aaa`},children:`Tablet`}),(0,H.jsxs)(`select`,{className:`form-control`,value:le(`uib-col-md-`)||``,onChange:e=>N(e.target.value,`tablet:`),children:[(0,H.jsx)(`option`,{value:``,children:`Auto`}),[...Array(12)].map((e,t)=>(0,H.jsx)(`option`,{value:t+1,children:t+1},t+1))]})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`label`,{style:{fontSize:`12px`,color:`#aaa`},children:`Mobile`}),(0,H.jsxs)(`select`,{className:`form-control`,value:le(`uib-col-sm-`)||``,onChange:e=>N(e.target.value,`mobile:`),children:[(0,H.jsx)(`option`,{value:``,children:`Auto`}),[...Array(12)].map((e,t)=>(0,H.jsx)(`option`,{value:t+1,children:t+1},t+1))]})]})]})]})]}),!fe&&(0,H.jsx)(Wc,{title:`Content & Data`,defaultOpen:[`img`,`svg`,`text`,`h1`,`h2`,`h3`,`h4`,`h5`,`h6`,`p`,`span`].includes(t.tag),children:(0,H.jsxs)(`div`,{style:{marginTop:`16px`},children:[(t.tag===`img`||t.props?.isBgImage)&&(0,H.jsxs)(`div`,{className:`form-group`,style:{marginBottom:`16px`,display:`flex`,alignItems:`center`},children:[(0,H.jsx)(`input`,{type:`checkbox`,id:`bg-image-toggle`,checked:t.props?.isBgImage||!1,onChange:e=>{let n=e.target.checked,r={props:{...t.props,isBgImage:n}};if(n){r.tag=`div`,r.props.style={...t.props?.style,backgroundImage:`url(${t.content})`},r.label=`Bg Image Container`;let e=t.props?.class||``;r.props.class=e?`${e} background_image`:`background_image`}else{r.tag=`img`;let e={...t.props?.style};delete e.backgroundImage,delete e.backgroundSize,delete e.backgroundPosition,delete e.minHeight,r.props.style=e,r.label=`Image`;let n=t.props?.class||``;r.props.class=n.replace(`background_image`,``).trim()}c(t.id,r)},style:{marginRight:`8px`,cursor:`pointer`}}),(0,H.jsx)(`label`,{htmlFor:`bg-image-toggle`,style:{marginBottom:0,cursor:`pointer`},children:`Use as Background Image`})]}),P?(0,H.jsxs)(H.Fragment,{children:[(0,H.jsxs)(`div`,{className:`form-group`,children:[(0,H.jsx)(`label`,{children:t.tag===`img`?`Image Source`:t.tag===`svg`?`SVG Media`:`Text Content`}),t.tag===`img`||t.tag===`svg`?(0,H.jsx)(Lc,{mode:t.fieldMode||`static`,value:t.content||``,accept:t.tag===`svg`?`.svg,image/svg+xml`:`image/*,.svg`,label:t.tag===`svg`?`SVG`:`Image`,onUpdate:(e,n)=>c(t.id,{content:e,fieldMode:n})}):(0,H.jsx)(Fc,{mode:t.fieldMode||`static`,value:t.content||``,onUpdate:(e,n)=>c(t.id,{content:e,fieldMode:n})})]}),t.tag===`a`&&(0,H.jsxs)(H.Fragment,{children:[(0,H.jsxs)(`div`,{className:`form-group`,style:{marginTop:`16px`},children:[(0,H.jsx)(`label`,{children:`Link URL`}),(0,H.jsx)(Fc,{mode:t.props?.hrefMode||`static`,value:t.props?.href||``,onUpdate:(e,n)=>{a(t.id,`href`,e),a(t.id,`hrefMode`,n)}})]}),(0,H.jsxs)(`div`,{className:`form-group`,style:{marginTop:`16px`,display:`flex`,alignItems:`center`},children:[(0,H.jsx)(`input`,{type:`checkbox`,id:`link-target-toggle`,checked:t.props?.target===`_blank`,onChange:e=>{a(t.id,`target`,e.target.checked?`_blank`:``)},style:{marginRight:`8px`,cursor:`pointer`}}),(0,H.jsx)(`label`,{htmlFor:`link-target-toggle`,style:{marginBottom:0,cursor:`pointer`},children:`Open in new tab`})]})]})]}):(0,H.jsx)(`div`,{className:`component-fields`,children:(()=>{let e=i?.form_schema||{},n=typeof e==`object`&&!Array.isArray(e)?Object.entries(e):[];return n.length===0?(0,H.jsx)(`p`,{className:`no-items-hint`,children:`No editable fields.`}):n.map(([e,n])=>{let r=t.values?.[e]||{mode:`static`,value:``},i=typeof r==`object`?r:{mode:`static`,value:r},a=n.title||e;if(typeof a==`string`){let t=a.indexOf(`{`),n=a.lastIndexOf(`}`);t!==-1&&n!==-1&&n>t&&(a=a.substring(0,t)+a.substring(n+1)),a=a.replace(/\{\s*\{[\s\S]*?\}\s*\}/g,``).replace(/:\s*$/,``).trim(),a||=`${e} Field`}return(0,H.jsxs)(`div`,{className:`form-group`,children:[(0,H.jsx)(`label`,{children:a}),n.type===`image`?(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(Lc,{mode:i.mode,value:i.value,onUpdate:(n,r)=>l(t.id,e,n,r)}),(0,H.jsxs)(`div`,{className:`form-group`,style:{marginTop:`16px`,display:`flex`,alignItems:`center`},children:[(0,H.jsx)(`input`,{type:`checkbox`,id:`bg-toggle-${e}`,checked:i.isBgImage||!1,onChange:n=>{l(t.id,e,i.value,i.mode,{isBgImage:n.target.checked})},style:{marginRight:`8px`,cursor:`pointer`}}),(0,H.jsx)(`label`,{htmlFor:`bg-toggle-${e}`,style:{marginBottom:0,cursor:`pointer`},children:`Use as Background Image`})]})]}):(0,H.jsx)(Fc,{mode:i.mode,value:i.value,onUpdate:(n,r)=>l(t.id,e,n,r)})]},e)})})()})]})}),(0,H.jsxs)(Wc,{title:`Styles & Classes`,children:[(ue.includes(`uib-container`)||ue.includes(`uib-full-width`))&&(0,H.jsxs)(`div`,{className:`form-group`,style:{marginTop:`16px`,display:`flex`,alignItems:`center`},children:[(0,H.jsx)(`input`,{type:`checkbox`,id:`full-width-toggle`,checked:ue.includes(`uib-full-width`),onChange:e=>{let n=[...ue];e.target.checked?(n=n.filter(e=>e!==`uib-container`),n.includes(`uib-full-width`)||n.push(`uib-full-width`)):(n=n.filter(e=>e!==`uib-full-width`),n.includes(`uib-container`)||n.push(`uib-container`)),a(t.id,`class`,n.join(` `))},style:{marginRight:`8px`,cursor:`pointer`}}),(0,H.jsx)(`label`,{htmlFor:`full-width-toggle`,style:{marginBottom:0,cursor:`pointer`},children:`Full Width Container`})]}),(0,H.jsxs)(`div`,{className:`form-group`,style:{marginTop:ue.includes(`uib-container`)||ue.includes(`uib-full-width`)?`12px`:`16px`},children:[(0,H.jsx)(`label`,{children:`Apply Custom Style`}),(0,H.jsxs)(`select`,{className:`form-control`,onChange:e=>{if(!e.target.value)return;let n=(t.props?.class||``).split(/\s+/).filter(Boolean);if(!n.includes(e.target.value)){let r=[...n,e.target.value].join(` `);a(t.id,`class`,r)}e.target.value=``},children:[(0,H.jsx)(`option`,{value:``,children:`-- Select a style --`}),m.map(e=>(0,H.jsx)(`option`,{value:e.id.startsWith(`uib-`)?e.id:`uib-`+e.id,children:e.label||e.id},e.id))]})]}),(0,H.jsxs)(`div`,{className:`form-group`,style:{marginTop:`12px`},children:[(0,H.jsx)(`label`,{children:`Applied Classes`}),(0,H.jsx)(`div`,{className:`active-styles-list`,children:(()=>{let e=(t.props?.class||``).split(/\s+/).filter(Boolean);return e.length===0?(0,H.jsx)(`p`,{className:`help-text`,children:`No classes applied.`}):e.map(n=>{let r=t.label===`Container`&&(n===`container`||n===`uib-full-width`)||t.label===`Row`&&n===`row`||t.label===`Column`&&n===`column`;return(0,H.jsxs)(`div`,{className:`style-tag ${r?`is-protected`:``}`,children:[(0,H.jsx)(`span`,{className:`style-tag-label`,children:n}),!r&&(0,H.jsx)(`button`,{type:`button`,className:`style-tag-remove`,onClick:()=>{let r=e.filter(e=>e!==n).join(` `);a(t.id,`class`,r)},children:`✕`})]},n)})})()})]}),(0,H.jsxs)(`div`,{className:`form-group`,children:[(0,H.jsx)(`label`,{children:`Add Extra Class Manually`}),(0,H.jsx)(`input`,{type:`text`,className:`form-control`,placeholder:`Type class and press Enter...`,onKeyDown:e=>{if(e.key===`Enter`&&(e.preventDefault(),e.target.value.trim())){let n=e.target.value.trim(),r=(t.props?.class||``).split(/\s+/).filter(Boolean),i=n.split(/\s+/).filter(Boolean),o=[...r];i.forEach(e=>{let t=e.startsWith(`uib-`)?e:`uib-${e}`;o.includes(t)||o.push(t)}),a(t.id,`class`,o.join(` `)),e.target.value=``}}})]}),(0,H.jsx)(`button`,{type:`button`,className:`btn-secondary`,style:{width:`100%`,marginTop:`16px`},onClick:()=>o(t.id),children:`Reset all to Defaults`})]}),(0,H.jsx)(`div`,{className:`form-group`,style:{marginTop:`32px`,padding:`0 20px 20px 20px`},children:(0,H.jsxs)(`button`,{type:`button`,className:`delete-element-btn`,style:{width:`100%`},onClick:()=>{s(t.id),p()},children:[`Delete `,P?`Element`:`Instance`]})})]})})]})]})}function Kc({mode:e,onSavePage:t,onSaveAsComponent:n,onToggleStyles:r,sidebarOpen:i,onToggleSidebar:a}){return(0,H.jsxs)(`header`,{className:`ui-builder-action-bar`,children:[(0,H.jsxs)(`div`,{className:`bar-left`,children:[(0,H.jsx)(`button`,{type:`button`,className:`ss-sidebar-toggle ${i?`active`:``}`,onClick:a,title:i?`Hide Elements`:`Show Elements`,children:(0,H.jsxs)(`svg`,{width:`18`,height:`18`,viewBox:`0 0 20 20`,fill:`none`,children:[(0,H.jsx)(`rect`,{x:`1`,y:`2`,width:`6`,height:`16`,rx:`1`,stroke:`currentColor`,strokeWidth:`1.5`}),(0,H.jsx)(`rect`,{x:`9`,y:`2`,width:`10`,height:`16`,rx:`1`,stroke:`currentColor`,strokeWidth:`1.5`})]})}),(0,H.jsxs)(`div`,{className:`builder-logo`,children:[(0,H.jsx)(`span`,{className:`logo-icon`,style:{color:`var(--primary)`},children:`💠`}),(0,H.jsxs)(`span`,{className:`logo-text`,children:[`Site Studio `,(0,H.jsx)(`span`,{style:{fontWeight:300,opacity:.7},children:`Unified`})]})]}),(0,H.jsx)(`div`,{className:`mode-badge`,style:{background:e===`architect`?`#dbeafe`:`#dcfce7`,color:e===`architect`?`#1e40af`:`#166534`,fontSize:`10px`,fontWeight:700,padding:`2px 8px`,borderRadius:`10px`,textTransform:`uppercase`,letterSpacing:`0.05em`},children:e===`architect`?`Component Builder`:`Page Composer`})]}),(0,H.jsx)(`div`,{className:`bar-center`}),(0,H.jsx)(`div`,{className:`bar-right`,children:e===`architect`&&(0,H.jsx)(H.Fragment,{children:(0,H.jsxs)(`button`,{type:`button`,className:`btn-secondary`,onClick:r,children:[(0,H.jsx)(`span`,{className:`icon`,children:`🎨`}),` Style Library`]})})})]})}function qc({style:e,onSave:t,onBack:n}){let[r,i]=(0,_.useState)(()=>{let t=e.data;if(!t)return{selector:`&`,properties:{},custom_properties:{},children:[]};let n=JSON.parse(JSON.stringify(t)),r=e=>{e.properties&&(e.custom_properties||={},Object.keys(e.properties).forEach(t=>{Rc.includes(t)||(e.custom_properties[t]=e.properties[t],delete e.properties[t])})),e.children&&e.children.forEach(r)};return r(n),n}),[a,o]=(0,_.useState)([`root`]),[s,c]=(0,_.useState)(e.label||e.id),[l,u]=(0,_.useState)(e.id),[d,f]=(0,_.useState)(null),[p,m]=(0,_.useState)(``),[h,g]=(0,_.useState)(!1),[v,y]=(0,_.useState)(new Set),[b,x]=(0,_.useState)(null),[S,C]=(0,_.useState)(null),[w,ee]=(0,_.useState)(``),[T,E]=(0,_.useState)(``),[D,O]=(0,_.useState)(`desktop`),te=e=>e.toLowerCase().replace(/\s+/g,`-`).replace(/[^\w-]/g,``),ne=e=>{let t=e.target.value,n=te(s);c(t),(l===n||l.startsWith(`style-`))&&u(te(t))},k=(e,t)=>{if(t.length===1&&t[0]===`root`)return e;let n=e;for(let e=1;e<t.length;e++){if(!n.children||!n.children[t[e]])return n;n=n.children[t[e]]}return n},A=k(r,a),re=(e,t,n)=>{let r=JSON.parse(JSON.stringify(e)),i=r;if(t.length===1&&t[0]===`root`)Object.assign(i,n);else{for(let e=1;e<t.length;e++)i=i.children[t[e]];Object.assign(i,n)}return r};return(0,H.jsx)(`div`,{className:`style-builder-overlay`,onClick:e=>{e.target===e.currentTarget&&n()},children:(0,H.jsxs)(`div`,{className:`style-builder-sidebar`,onClick:e=>e.stopPropagation(),children:[(0,H.jsxs)(`div`,{className:`style-builder-header`,children:[(0,H.jsxs)(`div`,{className:`header-left`,children:[(0,H.jsxs)(`button`,{type:`button`,className:`back-btn`,onClick:n,children:[(0,H.jsx)(`span`,{children:`←`}),` `,e.isInstance?`Back to Layout`:`Back to Styles`]}),(0,H.jsx)(`div`,{className:`style-info`,children:e.isInstance?(0,H.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`4px`},children:[(0,H.jsxs)(`span`,{className:`style-label-static`,style:{fontWeight:600,fontSize:`15px`,color:`var(--sb-text-main)`},children:[`Instance Styling: `,s]}),(0,H.jsx)(`div`,{style:{fontSize:`11px`,color:`#64748b`},children:`Scoped styling directly for this element instance`})]}):(0,H.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`4px`},children:[(0,H.jsx)(`input`,{type:`text`,value:s,onChange:ne,className:`style-label-input`,placeholder:`Enter Style Label`}),(0,H.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`4px`,fontSize:`11px`,color:`#64748b`},children:[(0,H.jsx)(`span`,{children:`Class:`}),(0,H.jsx)(`span`,{style:{fontFamily:`monospace`},children:`.uib-`}),(0,H.jsx)(`input`,{type:`text`,value:l,onChange:e=>u(te(e.target.value)),style:{border:`none`,background:`transparent`,color:`#64748b`,fontFamily:`monospace`,outline:`none`,padding:0,width:`150px`},placeholder:`class-name`})]})]})})]}),(0,H.jsx)(`div`,{className:`header-actions`,children:(0,H.jsx)(`button`,{type:`button`,className:`save-btn`,onClick:()=>{let n=JSON.parse(JSON.stringify(r));if(w.trim()&&T.trim()){let e=n;for(let t=1;t<a.length;t++)e=e.children[a[t]];e.custom_properties||={},e.custom_properties[w.trim()]=T.trim()}e.isInstance?t({...e,data:n}):t({...e,label:s,id:l||e.id,old_id:e.id,data:n})},children:`Save Style`})})]}),(0,H.jsxs)(`div`,{className:`style-builder-body`,children:[(0,H.jsxs)(`div`,{className:`style-builder-tree`,children:[(0,H.jsx)(`div`,{className:`tree-header`,children:`Selectors & Modifiers`}),(0,H.jsx)(Uc,{data:r,selectedNodePath:a,setSelectedNodePath:o,editingNodePath:d,setEditingNodePath:f,editValue:p,setEditValue:m,isAddingNew:h,setIsAddingNew:g,collapsedPaths:v,setCollapsedPaths:y,draggedNodePath:b,setDraggedNodePath:x,dropTargetInfo:S,setDropTargetInfo:C,onNodeAction:(e,...t)=>{switch(e){case`add`:{let[e,n]=t;e&&(e.preventDefault(),e.stopPropagation()),g(!0),m(`:hover`),f([...n,`new`]);break}case`rename`:{let[e,n]=t;if(e&&(e.preventDefault(),e.stopPropagation()),n.length===1&&n[0]===`root`)return;let i=k(r,n);g(!1),m(i.selector),f(n),o(n);break}case`finishEdit`:{let e=p.trim();if(!e){f(null),g(!1);return}if(h){let t=d.slice(0,-1);i(n=>{let r=JSON.parse(JSON.stringify(n)),i=r;if(t[0]!==`root`||t.length>1)for(let e=1;e<t.length;e++)i=i.children[t[e]];i.children=i.children||[];let a=i.children.length;return i.children.push({selector:e,properties:{},children:[]}),o([...t,a]),r})}else i(t=>re(t,d,{selector:e}));f(null),g(!1);break}case`dragStart`:{let[e,n]=t;x(n),e.dataTransfer.effectAllowed=`move`;break}case`dragOver`:{let[e,n,r]=t;if(e.preventDefault(),e.stopPropagation(),!b||JSON.stringify(n)===JSON.stringify(b))return;C({path:n,position:r});break}case`drop`:{let[e,n,r]=t;if(e&&(e.preventDefault(),e.stopPropagation()),!b)return;i(e=>{let t=JSON.parse(JSON.stringify(e)),i=t;for(let e=1;e<b.length-1;e++)i=i.children[b[e]];let a=b[b.length-1],[o]=i.children.splice(a,1);if(r===`inside`){let e=t;for(let t=1;t<n.length;t++)e=e.children[n[t]];e.children=e.children||[],e.children.push(o)}else{let e=t;for(let t=1;t<n.length-1;t++)e=e.children[n[t]];let i=n[n.length-1];b.length===n.length&&JSON.stringify(b.slice(0,-1))===JSON.stringify(n.slice(0,-1))&&a<i&&i--,r===`after`&&i++,e.children.splice(i,0,o)}return t}),x(null),C(null),o([`root`]);break}case`dragEnd`:x(null),C(null);break;case`delete`:{let[e,n]=t;if(e&&(e.preventDefault(),e.stopPropagation()),n.length===1&&n[0]===`root`)return;let a=k(r,n);if(a?.children&&a.children.length>0&&!window.confirm(`This selector has ${a.children.length} child element(s). Are you sure you want to delete it along with all its children?`))return;i(e=>{let t=JSON.parse(JSON.stringify(e)),r=t;for(let e=1;e<n.length-1;e++)r=r.children[n[e]];let i=n[n.length-1];return r.children.splice(i,1),t}),o([`root`]);break}}}})]}),(0,H.jsxs)(`div`,{className:`style-builder-properties`,children:[(0,H.jsxs)(`div`,{className:`props-header`,children:[(0,H.jsx)(`h2`,{children:A.selector===`&`?e.isInstance?`Base selector (&)`:`Base class (.uib-${e.id})`:A.selector}),(0,H.jsx)(`div`,{className:`props-header-path`,children:`Configuring properties for the selected selector`})]}),(0,H.jsx)(`div`,{className:`props-content`,children:(0,H.jsx)(Hc,{selectedNode:A,updateProperty:(e,t)=>{let n=JSON.parse(JSON.stringify(r)),o=n;for(let e=1;e<a.length;e++)o=o.children[a[e]];o.properties||={},t?o.properties[e]=t:delete o.properties[e],i(n)},updateCustomProperty:(e,t,n=null)=>{let o=JSON.parse(JSON.stringify(r)),s=o;for(let e=1;e<a.length;e++)s=s.children[a[e]];s.custom_properties||={},n&&n!==e&&delete s.custom_properties[n],t?s.custom_properties[e]=t:delete s.custom_properties[e],i(o)},pendingProp:w,setPendingProp:ee,pendingValue:T,setPendingValue:E,activeDevice:D,setActiveDevice:O})})]})]})]})})}function Jc({mode:e,initialLayout:t,initialSchema:n,availableComponents:r,onUpdate:i,onSavePage:a,initialStyle:o,onSaveStyle:s,onBackStyle:c}){let[l,u]=(0,_.useState)(()=>{let e=t||[],n=e=>(e||[]).map(e=>{if(!e)return null;let t={...e};if(e.component_id&&(!e.children||e.children.length===0)){let n=(r||[]).find(t=>t.id===e.component_id);if(n)try{let e=typeof n.layout_tree==`string`?JSON.parse(n.layout_tree):n.layout_tree,r=e&&e[0],i=e&&e.length===1&&r&&!ac.includes(r.tag||r.type||``)&&!(r.children&&r.children.length>0);if(t.isComponentRoot=!0,!t.values){t.values={};let e=typeof n.form_schema==`string`?JSON.parse(n.form_schema):n.form_schema;e&&typeof e==`object`&&Object.entries(e).forEach(([e,n])=>{n&&n.default&&(t.values[e]={...n.default})})}if(i)yc([t],t.values);else{let n=e=>{if(!e)return null;let t={...e,tag:e.tag||e.type,id:Math.random().toString(36).substr(2,9),originalId:e.originalId||e.id,originalContent:e.originalContent===void 0?e.content:e.originalContent,originalProps:e.originalProps||(e.props?{...e.props}:{})};return t.children&&=t.children.map(n),t};t.children=(e||[]).map(n).filter(Boolean),yc(t.children,t.values)}}catch(e){console.error(`Failed to hydrate component on load`,e)}}return t.children&&=n(t.children),t}).filter(Boolean);return mc(n(e))}),[d,f]=(0,_.useState)(()=>(r||[]).map(e=>({...e,layout_tree:e.layout_tree?typeof e.layout_tree==`string`?JSON.parse(e.layout_tree):mc(e.layout_tree):[],form_schema:pc(e.form_schema)}))),[p,m]=(0,_.useState)([]),[h,g]=(0,_.useState)(null),[v,y]=(0,_.useState)(null),[b,x]=(0,_.useState)(null),[S,C]=(0,_.useState)(!1),[w,ee]=(0,_.useState)(null),[T,E]=(0,_.useState)(!1),[D,O]=(0,_.useState)(!1),[te,ne]=(0,_.useState)(null);(0,_.useEffect)(()=>(document.body.classList.add(`using-ui-builder`),()=>{document.body.classList.remove(`using-ui-builder`)}),[]),(0,_.useEffect)(()=>{fetch(`/api/ui-builder/styles`).then(e=>e.json()).then(e=>{m(e)}).catch(e=>console.error(`Failed to fetch styles:`,e))},[]);let k=e=>{y(p.find(t=>t.id===e)||{id:e,label:e,data:null}),C(!1)},A=(0,_.useRef)(null),re=e=>{let t=vc(l,e),n=t?t.id:e;g(n),y(null),A.current=n},ie=e=>{ne(e),C(!0),g(e),A.current=e},j=e=>{let t=vc(l,e),n=t?t.id:e;g(n),y(null),x(n),A.current=n},M=we(Ce(wt,{activationConstraint:{distance:5}}),Ce(yt));(0,_.useEffect)(()=>{if(e===`architect`){let e={},t=lc(l),n=t=>{t.forEach(t=>{let r=ac.includes(t.tag);if(t.isField===void 0?!r:t.isField){let n=t.fieldLabel?t.fieldLabel.toLowerCase().replace(/\s+/g,`_`).replace(/[^\w]/g,``):``;!n&&t.fieldMode===`mapping`&&typeof t.content==`string`&&(n=t.content.toLowerCase().replace(/\s+/g,`_`).replace(/[:.]/g,`_`).replace(/[^\w]/g,``)),n||=`field_${t.id}`;let r=typeof t.content==`string`?t.content.trim():t.tag===`img`?`Image`:``;/^\{\{\s*field_/i.test(r)&&(r=``);let i=r?`${t.tag.toUpperCase()}: ${r.substring(0,20)}`:`${t.tag.toUpperCase()} Field`,a=t.fieldLabel||(t.fieldMode===`mapping`?`Mapped: ${t.content}`:i);e[n]={type:t.tag===`img`?`image`:`textfield`,title:a,default:{mode:t.fieldMode||`static`,value:t.content||``}},t.content=`{{ ${n} }}`}else typeof t.content==`string`&&t.content.includes(`{{`)&&(t.content=``);t.children&&n(t.children)})};n(t),i&&i(t,e)}else i&&i(l)},[l,e,i]),(0,_.useEffect)(()=>{let e=`uib-dynamic-layout-styles`,t=document.getElementById(e);t||(t=document.createElement(`style`),t.id=e,document.head.appendChild(t));let n=(e,t,n=!1)=>{if(!e)return``;let r=``,i=(e,t,a=!1)=>{let o=e.selector?e.selector.trim():``;o=o.includes(`&`)?o.replace(/&/g,t):o.startsWith(`:`)?`${t}${o}`:`${t} ${o}`;let s=[],c={};e.properties&&Object.entries(e.properties).forEach(([e,t])=>{a&&n&&(e===`max-width`||e===`flex`)||t&&s.push(`${e}: ${t} !important;`)}),e.custom_properties&&Object.entries(e.custom_properties).forEach(([e,t])=>{if(t)if(e.startsWith(`tablet:`)){let n=e.replace(`tablet:`,``);c.tablet||=[],c.tablet.push(`${n}: ${t} !important;`)}else if(e.startsWith(`mobile:`)){let n=e.replace(`mobile:`,``);c.mobile||=[],c.mobile.push(`${n}: ${t} !important;`)}else{if(a&&n&&(e===`max-width`||e===`flex`))return;s.push(`${e}: ${t} !important;`)}}),s.length>0&&(r+=`${o} { ${s.join(` `)} }\n`),c.tablet&&c.tablet.length>0&&(r+=`@media (max-width: 1024px) { ${o} { ${c.tablet.join(` `)} } }\n`),c.mobile&&c.mobile.length>0&&(r+=`@media (max-width: 767px) { ${o} { ${c.mobile.join(` `)} } }\n`),e.children&&e.children.forEach(e=>i(e,o,!1))};return i(e,t,!0),r},r=e=>{let t=``;return e.forEach(e=>{let i=`.uib-${e.id}`;if(e.props&&e.props.class){let t=cc(e.props.class,e.tag,e.label).split(` `).filter(Boolean).filter(t=>t!==`uib-${e.id}`&&!t.startsWith(`uib-col-`));t.length>0&&(i=t.map(e=>`.${e}`).join(``))}if(e.props){let n=[];e.props.flexDirection&&n.push(`flex-direction: ${e.props.flexDirection} !important;`),e.props.justifyContent&&n.push(`justify-content: ${e.props.justifyContent} !important;`),e.props.alignItems&&n.push(`align-items: ${e.props.alignItems} !important;`),e.props.alignSelf&&n.push(`align-self: ${e.props.alignSelf} !important;`),e.props.flexGrow!==void 0&&e.props.flexGrow!==0&&n.push(`flex-grow: ${e.props.flexGrow} !important;`),e.props.flexShrink!==void 0&&e.props.flexShrink!==1&&n.push(`flex-shrink: ${e.props.flexShrink} !important;`),e.props.width&&n.push(`width: ${e.props.width} !important;`),e.props.height&&n.push(`height: ${e.props.height} !important;`),n.length>0&&(t+=`${i} { ${n.join(` `)} }\n`)}if(e.instanceStyles){let r=e.props?.class?.split(` `).some(e=>e.startsWith(`uib-col-`));t+=n(e.instanceStyles,i,r)}e.children&&(t+=r(e.children))}),t};t.textContent=r(l)},[l]);let ae=e=>{let{active:t}=e,n=t.data.current?.type===`sidebar-element`;if(console.log(`[DnD] dragStart:`,t.id,`sidebar:`,n),E(!0),n){let e=t.data.current.element;ee({id:t.id,tag:e.type,label:e.label,props:{...e.defaultProps||{}},children:[]})}else ee(uc(l,t.id))},oe=e=>{},se=e=>{let t=e=>(e||[]).map(e=>e?{...e,tag:e.tag||e.type,id:Math.random().toString(36).substr(2,9),children:t(e.children)}:null).filter(Boolean);return{id:Math.random().toString(36).substr(2,9),tag:e.type,label:e.label,props:{...e.defaultProps||{class:``}},children:e.defaultChildren?t(e.defaultChildren):[],content:e.defaultContent||``,fieldMode:`static`,isField:e.isField||!1}},ce=e=>{let{active:t,over:n}=e;if(console.log(`[DnD] dragEnd:`,t.id,`→`,n?.id||`NONE`),ee(null),E(!1),!n)return;let r=t.data.current?.type===`sidebar-element`,i=String(n.id);u(e=>{let a=lc(e),o;if(r){let e=t.data.current.element;o=se(e)}else{if(t.id===n.id)return e;let r=dc(a,t.id);if(!r)return e;[o]=r.parent.splice(r.index,1)}if(i===`canvas-root`)return a.push(o),a;if(i.startsWith(`gap::`)){let e=i.split(`::`),t=e[1],n=parseInt(e[2],10);if(t===`canvas-root`)a.splice(n,0,o);else{let e=uc(a,t);e?(e.children=e.children||[],e.children.splice(n,0,o)):a.push(o)}return a}if(i.startsWith(`inside::`)){let e=uc(a,i.replace(`inside::`,``));return e?(e.children=e.children||[],e.children.push(o)):a.push(o),a}let s=dc(a,i);if(s){let e=s.parent[s.index];ac.includes(e.tag)?(e.children=e.children||[],e.children.push(o)):s.parent.splice(s.index,0,o)}else a.push(o);return a})},le=e=>{let t=se(e);u(n=>{let r=lc(n),i=te||A.current;if(i){let a=uc(r,i);if(a&&gc(a,e))return a.children=a.children||[],a.children.push(t),ne(null),r;if(a)return alert(`Cannot add ${e.label} inside ${a.label||a.tag}`),n}return ne(null),[...r,t]})},N=e=>{let t=d.find(t=>t.id===e);if(!t)return;let n=[];try{n=typeof t.layout_tree==`string`?JSON.parse(t.layout_tree):t.layout_tree}catch(e){console.error(`Failed to parse component layout`,e)}let r=e=>(e||[]).map(e=>e?{...e,tag:e.tag||e.type,id:Math.random().toString(36).substr(2,9),originalId:e.originalId||e.id,originalContent:e.originalContent===void 0?e.content:e.originalContent,originalProps:e.originalProps||(e.props?{...e.props}:{}),children:r(e.children)}:null).filter(Boolean),i={},a=typeof t.form_schema==`string`?JSON.parse(t.form_schema):t.form_schema;a&&typeof a==`object`&&Object.entries(a).forEach(([e,t])=>{t&&t.default&&(i[e]={...t.default})});let o=r(n),s=n&&n[0];if(n&&n.length===1&&s&&!ac.includes(s.tag||s.type||``)&&!(s.children&&s.children.length>0)){let t={...o[0],component_id:e,isComponentRoot:!0,values:i};yc([t],i);let n=[t];if(n.length===0)return;u(e=>{let t=lc(e),r=te||A.current;if(r){let e=uc(t,r);if(ac.includes(e?.tag)||e?.children&&e?.children.length>0)return e.children=e.children||[],e.children.push(...n),ne(null),t}return ne(null),[...t,...n]});return}yc(o,i);let c=o.map(t=>({...t,component_id:e,isComponentRoot:!0,values:i}));c.length!==0&&u(e=>{let t=lc(e),n=te||A.current;if(n){let e=uc(t,n);if(ac.includes(e?.tag)||e?.children&&e?.children.length>0)return e.children=e.children||[],e.children.push(...c),ne(null),t}return ne(null),[...t,...c]})},P=e=>{u(t=>{let n=lc(t),r=uc(n,e);if(r){let e=null;for(let t of ic)if(e=t.elements.find(e=>e.type===r.tag&&e.label===r.label),e)break;e&&(r.props={...e.defaultProps||{class:``}},r.isField||(r.content=e.defaultContent||``))}return n})},ue=(e,t,n)=>{u(r=>{let i=lc(r),a=uc(i,e);return a&&(a.props=a.props||{},n===``||n==null?delete a.props[t]:a.props[t]=n),i})},de=(e,t)=>{u(n=>{let r=lc(n),i=uc(r,e);return i&&Object.assign(i,t),r})},fe=(e,t,n,r=`static`,i={})=>{u(a=>{let o=lc(a),s=uc(o,e);return s&&(s.values={...s.values||{},[t]:{...s.values?.[t]||{},mode:r,value:n,...i}},yc(s.children,s.values)),o})},pe=(e,t)=>{u(n=>{let r=lc(n),i=uc(r,e);return i&&(i.instanceStyles=t),r})},me=e=>{let t=uc(l,e);t?.children&&t.children.length>0&&!window.confirm(`This element has ${t.children.length} child element(s). Are you sure you want to delete it along with all its children?`)||(u(t=>hc(t,e)),g(null),A.current=null)},he=e=>{u(t=>{let n=lc(t),r=dc(n,e);if(!r)return t;let i=r.parent[r.index],a=e=>{let t={...e,id:Math.random().toString(36).substr(2,9)};return t.children&&=t.children.map(a),t},o=a(i);return r.parent.splice(r.index+1,0,o),n})},ge=(e,t)=>{let n=null;for(let e of ic)if(n=e.elements.find(e=>e.type===t),n)break;if(!n)return;let r={id:Math.random().toString(36).substr(2,9),tag:n.type,label:n.label,props:{...n.defaultProps||{}},content:n.defaultContent||``,children:n.defaultChildren?JSON.parse(JSON.stringify(n.defaultChildren)).map(e=>({...e,id:Math.random().toString(36).substr(2,9)})):[],isField:n.isField};u(t=>{let n=lc(t),i=uc(n,e);return i&&(i.children=i.children||[],i.children.push(r)),n})},_e=e=>{let t={},n=e=>{let r=e.fieldLabel?e.fieldLabel.toLowerCase().replace(/\s+/g,`_`).replace(/[^\w]/g,``):``;!r&&e.fieldMode===`mapping`&&typeof e.content==`string`&&(r=e.content.toLowerCase().replace(/\s+/g,`_`).replace(/[:.]/g,`_`).replace(/[^\w]/g,``)),!r&&(e.isField||!ac.includes(e.tag))&&(r=`field_${e.id}`),r&&(t[r]={title:e.fieldLabel||(e.fieldMode===`mapping`?`Mapped: ${e.content}`:`${e.tag.toUpperCase()} Field`),type:e.tag===`img`?`image`:`textfield`,default:{mode:e.fieldMode||`static`,value:e.content||``}}),e.children&&e.children.forEach(n)};return n(e),t},ve=async(e=null)=>{let t=null;if(e?t=uc(l,e):h?t=uc(l,h):l.length===1&&(t=l[0]),!t){alert(`Please select a section or component to save.`);return}let n=prompt(`Enter component name:`,t.label||`New Component`);if(!n)return;let r=n.toLowerCase().replace(/\s+/g,`_`).replace(/[^\w]/g,``),i=_e(t),a={label:n,id:r,layout_tree:JSON.stringify([t]),form_schema:JSON.stringify(i)};try{let e=await(await fetch(`/api/ui-builder/component/save`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(a)})).json();e.success?(alert(`Component saved successfully!`),window.location.reload()):alert(`Failed to save component: `+(e.message||`Unknown error`))}catch(e){console.error(e),alert(`Network error while saving component.`)}},ye=async e=>{try{let t={...e};(await(await fetch(`/api/ui-builder/style/save`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)})).json()).success&&(m(t=>{let n=[...t];e.old_id&&e.old_id!==e.id&&(n=n.filter(t=>t.id!==e.old_id));let r=n.findIndex(t=>t.id===e.id);return r>-1?n[r]={...n[r],...e}:n.push({...e}),n}),e.old_id&&e.old_id!==e.id&&(u(t=>{let n=lc(t),r=`uib-${e.old_id}`,i=`uib-${e.id}`,a=e=>{e.forEach(e=>{if(e.props&&e.props.class){let t=e.props.class.split(` `),n=t.indexOf(r);n!==-1&&(t[n]=i,e.props.class=t.join(` `))}e.children&&a(e.children)})};return a(n),n}),v&&v.id===e.old_id&&y({...e})),alert(`Style saved!`))}catch{alert(`Failed to save style`)}},be=()=>{if(e===`composer`&&a)a();else{let e=document.querySelector(`input[id^="edit-submit"]`);e?e.click():alert(`Layout synced. Click "Save" on the Drupal page to persist changes.`)}},F=h?uc(l,h):null,xe=b?uc(l,b):null,Se=xe?d.find(e=>e.id===xe.component_id):null,Te=v,Ee=e=>{let t=Ie(e).filter(t=>t.id!==e.active.id),n=t.filter(e=>String(e.id).startsWith(`gap::`)),r=t.filter(e=>String(e.id).startsWith(`inside::`)),i=t.find(e=>e.id===`canvas-root`),a=t.filter(e=>!String(e.id).startsWith(`gap::`)&&!String(e.id).startsWith(`inside::`)&&e.id!==`canvas-root`);return n.length>0?Me({...e,droppableContainers:e.droppableContainers.filter(e=>n.some(t=>t.id===e.id))}):r.length>0?Me({...e,droppableContainers:e.droppableContainers.filter(e=>r.some(t=>t.id===e.id))}):a.length>0?Me({...e,droppableContainers:e.droppableContainers.filter(e=>a.some(t=>t.id===e.id))}):i?[i]:Me(e)},De={sideEffects:Fn({styles:{active:{opacity:`0.5`}}})};return e===`style`?(0,H.jsx)(`div`,{className:`ui-builder-style-editor-wrapper style-builder-standalone`,children:(0,H.jsx)(qc,{style:o,onSave:s,onBack:c})}):(0,H.jsxs)(`div`,{className:`ui-builder-container mode-${e}`,onKeyDown:e=>{e.key===`Enter`&&e.target.tagName.toLowerCase()===`input`&&(e.preventDefault(),e.stopPropagation(),e.nativeEvent&&e.nativeEvent.stopImmediatePropagation&&e.nativeEvent.stopImmediatePropagation())},children:[(0,H.jsx)(Kc,{mode:e,onSavePage:be,onSaveAsComponent:ve,onToggleStyles:()=>{},sidebarOpen:S,onToggleSidebar:()=>C(e=>!e)}),(0,H.jsxs)(`div`,{className:`builder-body`,children:[S&&(0,H.jsx)(Pc,{mode:e,availableComponents:d,customStyles:p,selectedNodeId:h,selectedNode:F,addElement:e=>{le(e)},addComponentInstance:e=>{N(e)},onSelectStyle:k,onDeselect:()=>{g(null),y(null),x(null),A.current=null},onClose:()=>C(!1)}),(0,H.jsx)(`main`,{className:`ui-builder-canvas`,children:(0,H.jsxs)(`div`,{className:`canvas-content`,onClick:()=>{g(null),y(null),x(null),A.current=null},children:[(0,H.jsxs)(`div`,{className:`ss-canvas-header`,onClick:e=>e.stopPropagation(),children:[(0,H.jsx)(`span`,{className:`ss-canvas-header-title`,children:`▼ Layout canvas`}),(0,H.jsxs)(`span`,{className:`ss-canvas-header-right`,children:[(0,H.jsx)(`span`,{className:`ss-canvas-link`,children:`Preview`}),(0,H.jsx)(`span`,{className:`ss-canvas-icon`,title:`Toggle visibility`,children:`👁`}),(0,H.jsx)(`span`,{className:`ss-canvas-icon`,title:`Settings`,children:`⚙`}),(0,H.jsx)(`span`,{className:`ss-canvas-icon`,title:`Help`,children:`❓`})]})]}),(0,H.jsxs)(`div`,{className:`ss-canvas-toolbar`,onClick:e=>e.stopPropagation(),children:[(0,H.jsx)(`button`,{type:`button`,className:`ss-canvas-add-btn`,onClick:()=>C(!0),title:`Add element`,children:`+`}),(0,H.jsx)(`span`,{style:{flex:1}}),(0,H.jsx)(`button`,{type:`button`,className:`ss-canvas-options-btn`,onClick:()=>{let e=!D;O(e),window.dispatchEvent(new CustomEvent(e?`ss-collapse-all`:`ss-expand-all`))},children:D?`Expand All`:`Collapse All`})]}),l.length===0?(0,H.jsx)(`div`,{className:`ss-canvas-empty`,children:(0,H.jsxs)(`p`,{children:[`Click `,(0,H.jsx)(`strong`,{children:`+`}),` or open the Elements panel to start building.`]})}):(0,H.jsx)(xc.Provider,{value:{isDraggingGlobal:T},children:(0,H.jsxs)(xn,{sensors:M,collisionDetection:Ee,onDragStart:ae,onDragOver:oe,onDragEnd:ce,measuring:{droppable:{strategy:Lt.Always}},children:[(0,H.jsx)(Oc,{nodes:l,selectedId:h,onSelect:re,onOpenProperties:j,onDuplicate:he,onDelete:me,onQuickAdd:ge,onStartTargetedAdd:ie,onSaveAsComponent:ve,pendingParentId:te,availableComponents:d}),(0,H.jsx)(Vn,{dropAnimation:De,children:w?(0,H.jsx)(Ec,{node:w,mode:e,selectedId:null,onSelect:()=>{},onQuickAdd:()=>{},availableComponents:d,isOverlay:!0}):null})]})})]})})]}),(0,H.jsx)(Gc,{mode:e,selectedNode:xe,selectedNodeId:b,selectedStyle:Te,selectedComponent:Se,updateNodeProperty:ue,resetToDefaultProps:P,removeNode:e=>{me(e),x(null)},updateNodeField:de,updateInstanceValue:fe,updateInstanceStyles:pe,onSaveStyle:ye,onEditInstanceStyle:e=>y(e),onDeselect:()=>{x(null),g(null),y(null),A.current=null},customStyles:p}),v&&(0,H.jsx)(qc,{style:v,onSave:e=>{e.isInstance?pe(e.id,e.data):ye(e),y(null)},onBack:()=>y(null)}),(0,H.jsx)(rc,{endpoint:`http://localhost:4747`})]})}document.addEventListener(`DOMContentLoaded`,()=>{let e=document.getElementById(`ui-builder-react-app`);if(e){let t=document.getElementById(`ui-builder-layout-tree-input`),n=document.getElementById(`ui-builder-form-schema-input`),r=[],i={};try{t&&t.value&&(r=JSON.parse(t.value)),n&&n.value&&(i=JSON.parse(n.value))}catch(e){console.error(`Failed to parse initial UI Builder JSON`,e)}(0,v.createRoot)(e).render((0,H.jsx)(_.StrictMode,{children:(0,H.jsx)(Jc,{mode:`architect`,initialLayout:r,initialSchema:i,onUpdate:(e,r)=>{t&&(t.value=JSON.stringify(e,null,2)),n&&(n.value=JSON.stringify(r,null,2))}})}))}let t=document.getElementById(`ui-builder-composer-mount`);if(t){let e=t.getAttribute(`data-field-id`),n=document.getElementById(e),r=[];try{n&&n.value&&(r=JSON.parse(n.value))}catch(e){console.error(`Failed to parse composer JSON`,e)}let i=e=>{n&&(n.value=JSON.stringify(e,null,2))},a=()=>{if(n){let e=n.closest(`form`);if(e){let t=e.querySelector(`#edit-submit, [data-drupal-selector="edit-submit"], input[type="submit"][value="Save"]`);t?t.click():e.submit()}}},o=window.drupalSettings?.ui_builder?.composer?.available_components||[];(0,v.createRoot)(t).render((0,H.jsx)(_.StrictMode,{children:(0,H.jsx)(Jc,{mode:`composer`,initialLayout:r,availableComponents:o,onUpdate:i,onSavePage:a})}))}let n=document.getElementById(`ui-builder-style-mount`);if(n){let e=document.getElementById(`ui-builder-style-data-input`),t=document.getElementById(`edit-label`),r=document.getElementById(`edit-id`),i=null;try{e&&e.value&&(i=JSON.parse(e.value))}catch(e){console.error(`Failed to parse style JSON`,e)}(!i||typeof i!=`object`||Array.isArray(i))&&(i={selector:`&`,properties:{},custom_properties:{},children:[]});let a={id:r?r.value:``,label:t?t.value:``,data:i},o=n=>{e&&(e.value=JSON.stringify(n.data,null,2)),t&&(t.value=n.label);let r=e.closest(`form`);if(r){let e=r.querySelector(`#edit-submit, [data-drupal-selector="edit-submit"]`);e?e.click():r.submit()}},s=()=>{window.location.href=`/admin/ui-builder/styles`},c=n.closest(`form`);c&&Array.from(c.children).forEach(e=>{e.contains(n)||(e.classList.contains(`form-item`)||e.classList.contains(`js-form-item`)||e.classList.contains(`form-actions`)||e.classList.contains(`js-form-wrapper`)||e.classList.contains(`form-wrapper`))&&(e.style.display=`none`)}),(0,v.createRoot)(n).render((0,H.jsx)(_.StrictMode,{children:(0,H.jsx)(Jc,{mode:`style`,initialStyle:a,onSaveStyle:o,onBackStyle:s})}))}});